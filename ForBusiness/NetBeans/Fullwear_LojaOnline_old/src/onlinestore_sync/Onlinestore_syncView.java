...
public class Onlinestore_syncView extends FrameView {

    public static int application_state = 0;

    public Onlinestore_syncView(SingleFrameApplication app) {
        super(app);
        initComponents();
    }
    ...
    public void showSincBox() {
        if (sincBox == null) {
            JFrame mainFrame = Onlinestore_syncApp.getApplication().getMainFrame();
            sincBox = new Onlinestore_syncSincBox(mainFrame);
            sincBox.setLocationRelativeTo(mainFrame);
        }
        Onlinestore_syncApp.getApplication().show(sincBox);
    }
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = Onlinestore_syncApp.getApplication().getMainFrame();
            aboutBox = new Onlinestore_syncAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        Onlinestore_syncApp.getApplication().show(aboutBox);
    }
	...
	mainPanel.setPreferredSize( new Dimension( 640, 316 ) );
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(onlinestore_sync.Onlinestore_syncApp.class).getContext().getResourceMap(Onlinestore_syncView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(onlinestore_sync.Onlinestore_syncApp.class).getContext().getActionMap(Onlinestore_syncView.class, this);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (application_state == 0) {
            ...
            try {
                ...
                Logger.getLogger(Onlinestore_syncView.class.getName()).log(Level.SEVERE, null, ex);
