			...
			case 'string':
				if(source.length) {
					loader = function() {
						...
						//init ewa hack
							var bostamp = jQuery("#prod").val();
							var u_psessstamp = jQuery("#sess").val();
						...
						var params = {from: d_from.getTime(), to: d_to.getTime(), utc_offset_from: d_from.getTimezoneOffset(), utc_offset_to: d_to.getTimezoneOffset(), bostamp:bostamp, u_psessstamp:u_psessstamp };
						//end ewa hack
