...
<div class="clearfix page-head col-md-12">
	<div class="col-md-12 col-sm-12">
		...
		<a target="_blank" href="<?php echo base_url()."wl/".$whitelabel["no"]; ?>" class="btn btn-info pull-right" style="margin-right:15px;"><?php echo $this->translation->Translation_key("View online", $_SESSION['lang_u']); ?></a>
	</div>
</div>
	...
	<div class="col-lg-12">
		<form>
			<div class="form-group">
				<label for="wl_template"><?php echo $this->translation->Translation_key("Name", $_SESSION['lang_u']); ?><?php echo $this->translation->Translation_key("Template", $_SESSION['lang_u']); ?></label>
			...
			<div class="form-group">
				<label for=""><?php echo $this->translation->Translation_key("Logo", $_SESSION['lang_u']); ?></label>
				<div class="">
			...
			<div class="form-group">
				<label><?php echo $this->translation->Translation_key("Background color", $_SESSION['lang_u']); ?></label>
			...
			<div class="form-group">
				<label><?php echo $this->translation->Translation_key("Content color", $_SESSION['lang_u']); ?></label>
			...
			<div class="form-group">
				<label><?php echo $this->translation->Translation_key("Header/Footer color", $_SESSION['lang_u']); ?></label>
			...
			<div class="form-group">
				<label><?php echo $this->translation->Translation_key("Menu Font color", $_SESSION['lang_u']); ?></label>
			...
			<div class="form-group">
				<label><?php echo $this->translation->Translation_key("Search Font color", $_SESSION['lang_u']); ?></label>
			...
			<div class="form-group">
				<label for="wl_font"><?php echo $this->translation->Translation_key("Font-family", $_SESSION['lang_u']); ?></label>
			...
			<div class="form-group">
				<label for="wl_font"><?php echo $this->translation->Translation_key("Menu", $_SESSION['lang_u']); ?></label>
				<table id="menus_table" class="table table-striped table-bordered" cellspacing="0" style="margin-bottom:5px" >
					<thead>
						<tr>
							<th><?php echo $this->translation->Translation_key("TEXT", $_SESSION['lang_u']); ?></th>
							<th><?php echo $this->translation->Translation_key("Protocol", $_SESSION['lang_u']); ?></th>
							<th><?php echo $this->translation->Translation_key("URL", $_SESSION['lang_u']); ?></th>
							<th><?php echo $this->translation->Translation_key("New Window", $_SESSION['lang_u']); ?></th>
							<th></th>
						</tr>
					</thead>
					<tbody>
				...
				<div class="col-lg-12 col-sm-12" style="margin-bottom:10px; ">
					<button type="button" id="menus_table_add" class="btn btn-info btn-lg pull-left" style=" margin-left:0;"><?php echo $this->translation->Translation_key("Add", $_SESSION['lang_u']); ?></button>
				</div>
			</div>
			<div class="form-group">
				<label><?php echo $this->translation->Translation_key("Payment Accepted URL", $_SESSION['lang_u']); ?></label>
				<div id="cont_pick" class="input-group colorpicker-component">
			...
			<div class="form-group">
				<label><?php echo $this->translation->Translation_key("Payment Rejected URL", $_SESSION['lang_u']); ?></label>
				<div id="cont_pick" class="input-group colorpicker-component">
					<input type="text" class="form-control" id="content_color" name="" value="">
					<span class="input-group-addon"><i></i></span>
				</div>
			...
			<div class="form-group">
				<label><?php echo $this->translation->Translation_key("Slider Images", $_SESSION['lang_u']); ?></label>
				<div class="">
					...
					<small>only Format Accepted .png / jpg / gif</br>
					Max FileSize: 1MB ( One Megabyte )</br>
					Max Width 2000px height 2000px </small>
					<div class="clearfix" data-alerts="alerts" data-ids="file" data-fade="3000"></div>
				</div>
			</div>
			
			<div class="form-group">
				<label for="example-text-input" class="col-2 col-form-label"><?php echo $this->translation->Translation_key("Slider Video URL", $_SESSION['lang_u']); ?></label>
				<div class="col-10">
			...
			<div class="form-group">
				<label for="example-text-input" class="col-2 col-form-label"><?php echo $this->translation->Translation_key("Search Title", $_SESSION['lang_u']); ?></label>
				<div class="col-10">
			...
			<div class="form-group">
				<label for="example-text-input" class="col-2 col-form-label"><?php echo $this->translation->Translation_key("Search Description", $_SESSION['lang_u']); ?></label>
				<div class="col-10">
			...
			<div class="form-group">
				<label for="whitelabel.customcss"><?php echo $this->translation->Translation_key("Custom CSS", $_SESSION['lang_u']); ?></label>
			...
			<div class="checkbox">
				<label>
					<input name="u_whitelabel.sliderproducts" type="checkbox" <?php echo ($whitelabel['sliderproducts'] == 1) ? "checked=''" : ""; ?>><?php echo $this->translation->Translation_key("Slider active in products page", $_SESSION['lang_u']); ?> 
				</label>
			</div>
			<div class="checkbox">
				<label>
					<input name="u_whitelabel.booknowproducts" type="checkbox" <?php echo ($whitelabel['booknowproducts'] == 1) ? "checked=''" : ""; ?>> <?php echo $this->translation->Translation_key("Products presentation with BOOK NOW button", $_SESSION['lang_u']); ?>
				</label>
			</div>
			<div class="checkbox">
				<label>
					<input name="u_whitelabel.sliderproduct" type="checkbox" <?php echo ($whitelabel['sliderproduct'] == 1) ? "checked=''" : ""; ?>> <?php echo $this->translation->Translation_key("Slider active in product page", $_SESSION['lang_u']); ?>
				</label>
			</div>
			<div class="checkbox">
				<label>
					<input name="u_whitelabel.sliderimage" type="checkbox" <?php echo ($whitelabel['sliderimage'] == 1) ? "checked=''" : ""; ?>> <?php echo $this->translation->Translation_key("First product image in product page as fixed slider", $_SESSION['lang_u']); ?>
				</label>
			</div>
			<div class="checkbox">
				<label>
					<input name="u_whitelabel.listgridbut" type="checkbox" <?php echo ($whitelabel['listgridbut'] == 1) ? "checked=''" : ""; ?>> <?php echo $this->translation->Translation_key("List/Grid Button active", $_SESSION['lang_u']); ?>
				</label>
			</div>
			<div class="checkbox">
				<label>
					<input name="u_whitelabel.filtersactive" type="checkbox" <?php echo ($whitelabel['filtersactive'] == 1) ? "checked=''" : ""; ?>><?php echo $this->translation->Translation_key("Filters active", $_SESSION['lang_u']); ?> 
				</label>
			</div>
			<div class="checkbox">
				<label>
					<input name="u_whitelabel.bxslider_auto" type="checkbox" <?php echo ($whitelabel['bxslider_auto'] == 1) ? "checked=''" : ""; ?>> <?php echo $this->translation->Translation_key("Slider Auto Start", $_SESSION['lang_u']); ?>
				</label>
			</div>
			<div class="form-group">
				<label for="whitelabel.bxslider_time"><?php echo $this->translation->Translation_key("Name", $_SESSION['lang_u']); ?>Slide transition duration (in ms)</label>
				<input type="number" class="form-control" min="0" id="whitelabel.bxslider_time" name="u_whitelabel.bxslider_time" value="<?php echo $whitelabel['bxslider_time']; ?>"/>
			</div>
			<div class="checkbox">
				<label>
					<input name="u_whitelabel.u_pagact" type="checkbox" <?php echo ($whitelabel['u_pagact'] == 1) ? "checked=''" : ""; ?>> <?php echo $this->translation->Translation_key("Pagination active", $_SESSION['lang_u']); ?>
				</label>
			</div>
			<div class="form-group">
				<label for="u_whitelabel.u_pagnum"><?php echo $this->translation->Translation_key("Pagination - Number Items per Page", $_SESSION['lang_u']); ?></label>
				<input name="u_whitelabel.u_pagnum" type="number" class="form-control" min="0" max="99" value="<?php echo number_format($whitelabel['u_pagnum'], 2, ".", ""); ?>">
				<small><?php echo $this->translation->Translation_key("Name", $_SESSION['lang_u']); ?>0 to disable this function</small>
			</div>
		</form>
		<p style="margin-bottom:25px"></p>
		<div class="clearfix" data-alerts="alerts" data-fade="3000"></div>
		<button data-step-control="save"  class="btn btn-info btn-lg pull-left" style="margin-bottom:25px"><?php echo $this->translation->Translation_key("SAVE", $_SESSION['lang_u']); ?></button>
	</div>
</div>
<script>
	$(document).ready(function () {
		...
		$("#slider_upload").dropzone({
			...
			addRemoveLinks: true,
			success: function (file, response){
				var filewidth = this.files[0].width;
				var fileheight = this.files[0].height;
				var filenome =  this.files[0].name;
				var filetype =  this.files[0].type;
				var filesize =  this.files[0].size/1024;
				//console.log(this.files);
				if(filesize < 1000 || fileheight < 2001 || filewidth < 2001 ){
					...
					{
						"message": "The file is: " + filenome + " of type: " + filetype + " of size: " + filesize+ " EXCEEDS THE SUPPORTED SIZE ",
						"priority": 'error'
					}
					]);
					this.removeFile(file);
