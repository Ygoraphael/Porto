            ...
            <div class="col-sm-12 col-md-12 col-xs-12 well text-center">
                <form action="#" class="form-horizontal group-border-dashed clearfix" >
                    <div class="form-group">
                        <label class="col-lg-2 col-sm-3 col-md-2 col-xs-12 control-label"><?php echo $this->translation->Translation_key("Initial Date", $_SESSION['lang_u']); ?></label>
                        ...
                        <?php if ($user["u_operador"] == 'Sim') { ?>
                            <label class="col-lg-2 col-sm-3 col-md-2 col-xs-12 control-label"><?php echo $this->translation->Translation_key("Agents", $_SESSION['lang_u']); ?></label>
                        <?php } else { ?>
                            <label class="col-lg-2 col-sm-3 col-md-2 col-xs-12 control-label"><?php echo $this->translation->Translation_key("Operators", $_SESSION['lang_u']); ?></label>
                        <?php } ?>
                        <div class="input-group col-lg-3 col-sm-3 col-md-2 col-xs-12 " style="margin-right:10px">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 col-sm-3 col-md-2 col-xs-12 control-label"><?php echo $this->translation->Translation_key("Final Date", $_SESSION['lang_u']); ?></label>
                        <div class="input-group col-lg-3 col-sm-3 col-md-2 col-xs-12" style="margin-right:10px">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 col-sm-3 col-md-2 col-xs-12 control-label"><?php echo $this->translation->Translation_key("Order number", $_SESSION['lang_u']); ?></label>
                        <div class="input-group col-lg-3 col-sm-3 col-md-2 col-xs-12" style="margin-right:10px">
                            <input type="number" min="0" class="form-control" id="obrano" value="0.00">
                        </div>
                    </div>
                    <div class="form-group">
                        <button class="btn btn-primary col-sm-12 col-md-12 col-xs-12" onclick="atualiza_tabela(); return false;"><i class="white halflings-icon search"></i><?php echo $this->translation->Translation_key("SHOW", $_SESSION['lang_u']); ?></button>
                    </div>
                </form>
                <table id="tab-p" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th><?php echo $this->translation->Translation_key("Order Number", $_SESSION['lang_u']); ?></th>
                            <th><?php echo $this->translation->Translation_key("Client Name", $_SESSION['lang_u']); ?></th>
