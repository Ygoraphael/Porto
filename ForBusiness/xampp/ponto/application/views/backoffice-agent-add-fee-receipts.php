			...
			<div class="col-sm-12 col-md-12 col-xs-12">
				<form action="#" class="form-horizontal group-border-dashed clearfix" >
					<div class="form-group">
						<label class="col-lg-2 col-sm-3 col-md-2  col-xs-12 control-label">Document Number</label>
					...
					<div class="form-group">
						<label class="col-lg-2 col-sm-3 col-md-2 col-xs-12 control-label">Value (€)</label>
						<div class="input-group col-lg-3 col-sm-3 col-md-3  col-xs-12" style="margin-right:10px">
							<input type="text" class="form-control" id="value" value=""placeholder="0.00" required >
						</div>
						<label class="col-lg-2 col-sm-3 col-md-2  col-xs-12 control-label">Date</label>
						<div class="input-group col-lg-3 col-sm-3 col-md-3  col-xs-12" style="margin-right:10px">
							<input type="date" class="form-control" id="date" value="" required >
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 col-sm-3 col-md-2  col-xs-12 control-label">Description</label>
					...
					<div class="form-group">
						<label class="col-lg-2 col-sm-3 col-md-2  col-xs-12 control-label">File</label>
						<div class="input-group col-lg-8 col-sm-8 col-md-8  col-xs-12" style="margin-right:10px">
					...
					<div class="form-group">
						<button onclick="save(); return false;" class="btn btn-info btn-lg col-sm-12 col-md-12 col-xs-12">SAVE</button>
					</div>
				</form>
			</div>
		</div>
