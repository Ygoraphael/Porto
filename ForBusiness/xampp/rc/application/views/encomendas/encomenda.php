    ...
    <div class="form-grids widget-shadow" data-example-id="basic-forms"> 
        ...
        <?php if (strlen(trim($enc["obstab2"]))): ?>
            <div class="col-xs-12" style="margin-bottom:15px;">
                <div id="email_anexo" class="collapse"><?= $enc["obstab2"]; ?></div>
            </div>
        <?php endif ?>
            ...
            <tbody>
                <?php foreach ($enclin as $lin) { ?>
                    ...
                    <tr>
                        ...
                        <td class=""><input type="number" min="0" max="<?= number_format($lin["qtt"], 2, '.', ''); ?>" step="1" class="form-control decimal_input" value="<?= number_format($lin["u_nciqttc"], 2, '.', ''); ?>"></td>
