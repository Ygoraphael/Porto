...
namespace NCPonto.Classes
{
    class Pico
    {
        ...
        private void CriaDossierPontoBI(string stamp, string obrano, int no, string nome, DateTime data, string matricula, string oobistamp, string horainicio, long tempoinicio, string nomeutil, string refer, string design, long lordem, string tipopico, string bistamp)
        {
            ...
            comm.CommandTimeout = 0;
            comm.CommandText = "INSERT INTO BI (POSIC, NDOS, NMDOS, biStamp, boStamp, ObraNO, No, Nome, DataObra, RData, LObs, LObs2, LObs3, BiNum1, BiNum2, LItem, Ref, Design, LOrdem, OOBIStamp, u_entrada1, u_saida1, u_entrada2, u_saida2, u_ent1T, u_sai1T, u_ent2T, u_sai2T) VALUES (@POSIC, @NDOS, @NMDOS, @BIStamp, @boStamp, @ObraNO, @No, @Nome, @DataObra, @RData, @LObs, @LObs2, @LObs3, @BiNum1, @BiNum2, @LItem, @Ref, @Design, @LOrdem, @OOBIStamp, @u_entrada1, @u_saida1, @u_entrada2, @u_saida2, @u_ent1T, @u_sai1T, @u_ent2T, @u_sai2T)";
