            ...
            <section>
                    ...
                    <div id="login-access" class="tab-pane fade active in">	
                        ...
                        <form id="form1" method="post" accept-charset="utf-8" autocomplete="off" role="form" class="form-horizontal">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control hide" name="agent_id" id="agent_id" placeholder="<?php echo $this->googletranslate->translate($_SESSION["language_code"], 'AGENT'); ?> ID" tabindex="1" value="" />
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group ">				
                                <button id="btn-login" name="log-me-in" tabindex="4" class="btn btn-lg btn-primary"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'LOGIN'); ?></button>
                                <button id="btn-login-private" name="" tabindex="5" class="btn btn-lg btn-primary hide"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'LOGIN PRIVATE'); ?></button>
                            </div>
                            <div class="form-group" id="btn-login-fb">	
                                <button type="button" tabindex="6" class="btn btn-lg btn-primary"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'LOGIN WITH '); ?>FACEBOOK</button>
                            </div>
                            <div class="form-group centered">	
                                <a class="pull-right btn-private" href="#" style="color:#818080;font-size: 13px;text-transform: uppercase;"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Private'); ?></a>
                                <a class="pull-right btn-public hide" href="#" style="color:#818080;font-size: 13px;text-transform: uppercase;"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Public'); ?></a>
                            </div>
                        </form>			
                    </div>
                </div>
                <div id="register-form" class="tab-content tabs-login col-lg-6 col-md-6 col-sm-6 cols-xs-6">
                    <div id="register-access" class="tab-pane fade active in">
                        <p>
                            <b><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Still not our customer?'); ?></b><br><br>
                            <?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Register now and have access to the best prices.'); ?>
                        </p>
                        <form id="form2" method="post" accept-charset="utf-8" autocomplete="off" role="form" class="form-horizontal">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" name="reg-email" id="reg-email" placeholder="<?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Email'); ?>" tabindex="7" value="" />
                            </div>
                            <div class="form-group ">
                                <label for="password" class="sr-only"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Password'); ?></label>
                                <input type="password" class="form-control" name="reg-password" id="reg-password" placeholder="<?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Password'); ?>" value="" tabindex="8" />
                            </div>
                            <div class="form-group ">
                                <label for="password" class="sr-only"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Confirm Password'); ?></label>
                                <input type="password" class="form-control" name="reg-cpassword" id="reg-cpassword" placeholder="<?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Confirm Password'); ?>" value="" tabindex="9" />
                            </div>
                            <div class="form-group ">				
                                <button name="register-me-in" id="btn-register" tabindex="10" class="btn btn-lg btn-primary"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'REGISTER NOW'); ?></button>
                            </div>
                        </form>			
                    </div>
                </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            jQuery(document).on('click', '.btn-public', function () {
                ...
                jQuery("#recaptcha").removeClass("hide");
