			...
			<div class="footer informative">
				<div class="inner">
					<div class="footer-column-1">
						<div class="footer-logo"><a title="RacingCycle" href="#"><img alt="footer  logo" src="images/logo.png" /></a></div>
						<div class="phone-footer">
							<p style="color: #fff;">Rua dos Lagoeiros Armazém 54<br>2415-644 Leiria - Portugal</p>
							<p style="color: #fff;"><strong>Email:</strong> info@racingcycle.net</p>
						</div>
					</div>
					<div class="footer-column">
						<h4><?php echo JText::_("NC_INFORMACOES"); ?></h4>
						<ul class="links">
							<?php
							if( $lang->getTag() == 'pt-PT' ) {
							?>
								<li class="first"><a title="FAQs" href="index.php/faqs">FAQs</a></li>
								<li><a title="Pagamentos" href="index.php/pagamentos">Pagamentos</a></li>
								<li><a title="Entregas" href="index.php/entregas">Entregas</a></li>
								<li class="last"><a title="Política de Devolução" href="index.php/politica-de-devolucao">Política de Devolução</a></li>
							<?php
							}
							else if( $lang->getTag() == 'en-GB' ) {
							?>
								<li class="first"><a title="FAQs" href="index.php/faqs">FAQs</a></li>
								<li><a title="Payments" href="index.php/payments">Payments</a></li>
								<li><a title="Deliveries" href="index.php/deliveries">Deliveries</a></li>
								<li class="last"><a title="Return Policy" href="index.php/return-policy">Return Policy</a></li>
					...
					<div class="footer-column">
						<h4><?php echo JText::_("NC_SERVICO_CLIENTES"); ?></h4>
						<ul class="links">
							<?php
							if( $lang->getTag() == 'pt-PT' ) {
							?>
								<?php if (JFactory::getUser()->id > 0) { ?>
								<li class="first"><a title="Área de Clientes" href="index.php/area-de-cliente">Área de Clientes</a></li>
								<?php } ?>
								<li><a title="Sobre Nós" href="index.php/sobre-nos">Sobre Nós</a></li>
							...
							?>
								<?php if (JFactory::getUser()->id > 0) { ?>
								<li class="first"><a title="Client Area" href="index.php/client-area">Client Area</a></li>
								<?php } ?>
