...
//]]>
    ...
    if ($this->order  ) {
	    ...
	    <form action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" >
	    	...
	    	<div class="width100 floatleft" id="com-form-order-number">
	    	...
	    	<div class="width30 floatleft" id="com-form-order-submit">
	    		<input type="submit" name="Submitbuton" class="" value="<?php echo JText::_('COM_VIRTUEMART_ORDER_BUTTON_VIEW') ?>" />
	    	</div>
	    	<div class="clr"></div>
...
<?php   }
    ...
    <form id="com-form-login" class="formLogin" action="<?php echo JRoute::_('index.php', $this->useXHTML, $this->useSSL); ?>" method="post" name="com-login" >
...
<?php }   ?>
        <p class="width100 floatleft" id="com-form-login-username">
        ...
        <p class="width100 floatleft" id="com-form-login-password">
        ...
        <p class="width100 floatleft" id="com-form-login-remember">
            <input type="submit" name="Submit" class="default" style="width:100%;" value="<?php echo JText::_('COM_VIRTUEMART_LOGIN') ?>" />
...
<?php  } else if ( $user->id ) { ?>
   ...
   <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="login" id="form-login">
	...
	<input type="submit" name="Submit" class="" value="<?php echo JText::_( 'COM_VIRTUEMART_BUTTON_LOGOUT'); ?>" />
        <input type="hidden" name="option" value="<?php echo $comUserOption ?>" />
        <?php if ( JVM_VERSION===1 ) { ?>
