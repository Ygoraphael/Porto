					...
					<form data-toggle="validator" role="form" action="#" style="border-radius: 0px;" class="form-horizontal group-border-dashed clearfix">
						<span>
							...
							<div class="col-lg-12 col-sm-12">
								<button type="button" id="seats_table_add" class="btn btn-info btn-lg pull-left">Add seat</button>
								<button type="button" id="seats_table_import" class="btn btn-info btn-lg pull-left">Import seats</button>
