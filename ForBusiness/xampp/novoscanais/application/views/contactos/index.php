<section id="intro" class="intro backgroundAnimContactos">
    <div class="slogan">
        <h2>Contacte-nos</h2>
  ...
  <div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="1000ms" >
      <div class="feature-wrap">
          <div class="row" style="text-align: center;">
              <div class="col-sm-12">
                  <a href="<?php echo base_url(); ?>contactos/pedido_contacto">
              ...
              <div class="col-sm-12 reset-contact">
                  ...
                  <div class="form-group">
                    <br>
                    <a href="<?php echo base_url(); ?>contactos/pedido_contacto" class="btn btn-primary btn-lg">Enviar Mensagem</a>
                  </div>
              </div>
          </div>
      </div>
      ...
      <div class="feature-wrap">
          <div class="row">
              ...
              <div class="col-sm-12 reset-contact">
                  ...
                  <h4>Requisite Informações sobre produtos</h4>
                  <div class="form-group">
                    <br>
                    <a href="<?php echo base_url(); ?>contactos/pedido_contacto" class="btn btn-primary btn-lg">Enviar Mensagem</a>
                  </div>
