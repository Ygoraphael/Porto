...
namespace NCDataOnline
{
    public partial class Form1 : Form
    {
        ...
        private Settings appSettings = new Settings(new Dictionary<string, string>
		{
			...
			{
				"PostRegcheckURL",
				"https://dashboard.novoscanais.com/dashboard/[%hash%]/index2.php"
			},
			
			{
				"PostPushURL",
				"https://dashboard.novoscanais.com/dashboard/[%hash%]/index.php"
			}
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                if (ThreadSafe.GetTextControl(this.tipo_basedados) == "SQLite")
                {
                    string connString = "Data Source=" + ThreadSafe.GetTextControl(this.bd) + ";Version=3;New=False;Compress=True;";
                    e.Result = SQL.TestarConexao(SQLConnType.SQLite, connString);
                }
                else if (this.tipo_basedados.Text == "MSSQL")
                {
        ...
        private void backgroundWorker2_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                if (ThreadSafe.GetTextControl(this.tipo_basedados) == "SQLite")
                {
                    ...
                    {
                        DataTable result = SQL.ExecutarSQL(SQLConnType.SQLite, connString, ThreadSafe.GetTextControl(this.sql));
                        e.Result = result;
                    }
                    else
                    {
