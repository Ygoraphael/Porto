...
//advanced settings
$display_types_advanced=array(5,6);
$script='var display_types_advanced=new Array("5","6","8");';
...
<form
	action="<?php echo JRoute::_('index.php?option=com_customfilters&view=customfilters'); ?>"
