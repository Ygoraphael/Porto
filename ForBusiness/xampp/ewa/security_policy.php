...
<div style="height:200px; margin-bottom:25px;">
	<div class="wide">
		...
		<div class="col-xs-2 logo">SECURITY POLICY</div>
		<div class="col-xs-5 line"><hr></div>
	</div>
</div>
<style>
...
<div class="container policy">
	<div class="col-lg-12">
		<span class="tituloPreto">Is buying by credit card safe?</span><br><br>
		...
		<br>
		<span class="tituloPreto">How can I check the security of my credit card purchase?</span><br><br>
		<ul>
		...
		<br><br>
		<span class="tituloPreto">What are the guarantees that my order will be processed?</span><br><br>
		...
		<br><br>
		<span class="tituloPreto">THIS SITE IS ACKNOWLEDGED AS: VERIFIED BY VISA, GUARANTEEING THE CONFIDENTIALITY OF ITS DATA AS WELL AS THE SAFETY IN THE ACT OF PAYMENT BY CREDIT CARD.</span><br><br>
	</div>
	<div class="col-lg-12">
