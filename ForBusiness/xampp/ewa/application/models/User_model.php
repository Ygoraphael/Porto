...
class User_model extends CI_Model {
    ...
    public function get_user_access($no, $estab, $acesso, $accessstamp) {
        ...
        $data_access_op[] = 'rep_pickups';
        $data_access_op[] = 'partialorder';
        $data_access_op[] = '';
    ...
    public function get_stamp() {
        ...
        $this->db->select('flstamp');
        $this->db->from('fl');
        $this->db->where('no', $_SESSION["backoffice_user_id"]);
        $this->db->where('estab', $_SESSION["backoffice_user_estab"]);
        $result = $this->db->get();
        $result = $result->result_array()[0]['flstamp'];
        return $result;
    }
