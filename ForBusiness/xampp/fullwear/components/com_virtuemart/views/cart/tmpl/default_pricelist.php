...
<div class="billto-shipto" >
	<table>
		...
		<tr>
			<td style="width:50%;">
				<a class="button button-caution" id="output-billto-edit" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=BT', $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
			...
			<td style="width:50%;">
				...
				<a class="button button-caution" id="output-shipto-add" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&virtuemart_user_id[]=' . $this->cart->lists['current_id'], $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
...
<table
	...
	width="100%">
<tr>
	<th align="left"   width="100px"><?php echo JText::_ ('COM_VIRTUEMART_CART_SKU') ?></th>
	<th align="left"   width="250px"><?php echo JText::_ ('COM_VIRTUEMART_CART_NAME') ?></th>
	<th align="left"   width="250px"><?php echo JText::_ ('COM_VIRTUEMART_CART_COLECTION') ?></th>
	<th align="center" width="70px"><?php echo JText::_ ('COM_VIRTUEMART_CART_PRICE_BASE') ?></th>
	<th align="center" width="90px"><?php echo JText::_ ('COM_VIRTUEMART_CART_PRICE_DESC') ?></th>
...
<tr valign="top" class="sectiontableentry<?php echo $i ?>">
	...
	<td align="left">
		<?php 
			...
			echo "<br>" . JText::_ ('MOD_VIRTUEMART_SIZE') . ": " . $pieces[2] . "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . JText::_ ('MOD_VIRTUEMART_COLOR') . ": " . $pieces[3];
		?>
	</td>
	<td align="left">
		<?php 
...
//				$step=$prow->min_order_level;
            ...
            <input type="text"
				   ...
				   title="<?php echo  JText::_('COM_VIRTUEMART_CART_UPDATE') ?>" class="quantity-input js-recalculate" style="vertical-align:top;margin-top:2px;" size="3" maxlength="4" name="quantity[<?php echo $prow->cart_item_id ?>]" value="<?php echo $prow->quantity ?>" />
...
<tr>
	<td colspan="2">&nbsp;</td>
	<td colspan="5"><h3 style="text-align:right;"><?php echo JText::_( 'IVAPreco' ); ?></h3></td>
</tr>
