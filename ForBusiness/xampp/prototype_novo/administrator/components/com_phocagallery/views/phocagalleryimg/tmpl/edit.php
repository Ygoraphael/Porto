...
?>			
		...
		<ul class="adminformlist">
			...
			<?php //echo $this->form->getLabel('description'); ?>			Descrição PT
			<div class="clr"></div>
			<?php echo $this->form->getInput('description'); ?>						<div class="clr"></div>			Descrição ENG			<div class="clr"></div>			<?php echo $this->form->getInput('description_eng'); ?>						<div class="clr"></div>			Prémios PT			<div class="clr"></div>			<?php echo $this->form->getInput('awards'); ?>						<div class="clr"></div>			Prémios ENG			<div class="clr"></div>			<?php echo $this->form->getInput('awards_eng'); ?>
