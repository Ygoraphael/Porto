...
public class Encomenda extends Db {
   ...
   public boolean save(Config conf) throws SQLException, ParseException 
   {
       ...
       try {
        ...
        bo.no = this.no;
        bo.nome = this.nome.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\])", "\\\\").replace("\"","").replace("\'","");
        bo.ncont = this.ncont.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\])", "\\\\").replace("\"","").replace("\'","");
        bo.morada = this.morada.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\])", "\\\\").replace("\"","").replace("\'","");
        bo.codpost=this.codpost.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\])", "\\\\").replace("\"","").replace("\'","");
        bo.local = this.local.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\])", "\\\\").replace("\"","").replace("\'","");
        bo.pais_origem = this.pais_origem.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\])", "\\\\").replace("\"","").replace("\'","");
        bo.email=this.email.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\])", "\\\\").replace("\"","").replace("\'","");
        bo.telefone = this.telefone.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\])", "\\\\").replace("\"","").replace("\'","");
        bo.envio = this.envio;
        bo.pagamento = this.pagamento;
        bo.order_number = this.order_number;
        ...
        bo.memissao = "EURO";
        bo.obs = this.obs.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\-])", "\\\\").replace("\"","").replace("\'","");
        ...
        d = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse( this.dataobra );
        bo.usrhora = d;
        bo.nome_entrega = this.nome_entrega.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\-])", "\\\\").replace("\"","").replace("\'","");
        bo.ncont_entrega = this.ncont_entrega.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\-])", "\\\\").replace("\"","").replace("\'","");
        bo.morada_entrega = this.morada_entrega.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\-])", "\\\\").replace("\"","").replace("\'","");
        bo.codpost_entrega = this.codpost_entrega.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\-])", "\\\\").replace("\"","").replace("\'","");
        bo.local_entrega = this.local_entrega.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\-])", "\\\\").replace("\"","").replace("\'","");
        bo.telefone_entrega = this.telefone_entrega.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\-])", "\\\\").replace("\"","").replace("\'","");
        bo.pais_origem_entrega = this.pais_origem_entrega.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\-])", "\\\\").replace("\"","").replace("\'","");
        bo.order_shipment = this.order_shipment.replaceAll("(?=[]\\[+&|!(){}^\"~*?:\\\\-])", "\\\\").replace("\"","").replace("\'","");
