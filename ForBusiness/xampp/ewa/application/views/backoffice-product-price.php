			...
			<div class="col-xs-12">
				<div class="col-md-12 well text-center">
					<form data-toggle="validator" role="form" action="#" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
						<span>
							<h3><?php echo $this->translation->Translation_key("PRODUCT PRICING", $_SESSION['lang_u']); ?></h3>
							<?php if( sizeof($u_pseat) ) { ?>
							<table id="pricing_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
								<thead>
									<tr>
										<th><?php echo $this->translation->Translation_key("Seat", $_SESSION['lang_u']); ?></th>
					...
					<button onclick="location.replace(document.referrer);" class="btn btn-primary btn-lg pull-left"><span class="glyphicon glyphicon-chevron-left"></span><?php echo $this->translation->Translation_key("BACK", $_SESSION['lang_u']); ?> </button>
					<button data-step-control="save"  class="btn btn-info btn-lg pull-left"><?php echo $this->translation->Translation_key("SAVE PRICES", $_SESSION['lang_u']); ?></button>
				</div>
			</div>
		</div>
	</div>
