                                    ...
                                    <div class="controls">
                                        <select id="tarefa" class="span8 form-control" required>
                                            ...
                                            foreach ($tarefas as $tarefa) {
                                                echo "<option value='" . $tarefa["u_tarstamp"] . "'>" . $tarefa["tarefa"] . "</option>";
                                            }
                                            ?>
                                        </select>
        ...
        <script>
            ...
            function filtra_projetos() {
                ...
                jQuery.ajax({
                    type: "POST",
                    url: "funcoes_gerais.php",
                    data: {"action": "tabela_projetos('" + jQuery("#cliente").val() + "', 'processo', 0);"},
                    success: function (data)
                    {
                        var obj = JSON.parse(data);
                        ...
                        $.each(obj, function (index, value) {
                            $('#projeto')
                                    .append($("<option></option>")
                                            .attr("value", value["processo"])
                                            .text(value["processo"] + " | " + value["descricao"]));
                        });
