...
<tr>
	...
	<th
		align="center"
		width="60px"><?php echo JText::_ ('COM_VIRTUEMART_CART_PRICE') ?>
	</th>
	<th
		align="right"
		width="140px"><?php echo JText::_ ('COM_VIRTUEMART_CART_QUANTITY') ?>/ <?php echo JText::_ ('COM_VIRTUEMART_CART_ACTION') ?>
	</th>
...
<tr valign="top" class="sectiontableentry<?php echo $i ?>">
	<td align="left" style="padding-top:5px;"><?php  echo $prow->product_sku ?></td>
...
//				$step=$prow->min_order_level;
			...
			<input type="submit" class="vmicon vm2-add_quantity_cart" name="update[<?php echo $prow->cart_item_id ?>]" title="<?php echo  JText::_ ('COM_VIRTUEMART_CART_UPDATE') ?>" style="vertical-align:top;" align="middle" value=""/>
	...
	<td align="right" style="padding-top:5px;"><?php echo "<span class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('taxAmount', '', $this->cart->pricesUnformatted[$pkey], FALSE, FALSE, $prow->quantity) . "</span>" ?></td>
	<td colspan="1" align="right" style="padding-top:5px;">
		<?php
...
<tr class="sectiontableentry1">
	<td colspan="4" align="right" style="padding-right:15px;"><?php echo JText::_ ('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_PRICES_TOTAL'); ?></td>
...
<?php //totais?>
<tr class="sectiontableentry2">
	<td colspan="4" align="right" style="padding-right:15px;"><?php echo JText::_ ('COM_VIRTUEMART_CART_TOTAL') ?>:</td>
	<td align="right">
		<?php 
