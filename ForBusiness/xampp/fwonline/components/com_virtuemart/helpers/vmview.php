...
class VmView extends JView{
	...
	public function prepareContinueLink(){
		...
		$this->continue_link_html = '<strong><h1><a style="margin-right:30px;" class="continue continue_link" href="' . $this->continue_link . '">' . JText::_ ('COM_VIRTUEMART_CONTINUE_SHOPPING') . '</a></h1></strong>';
