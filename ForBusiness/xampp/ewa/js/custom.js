...
function seat_qtt(sel, value, value2, data_field, _id, _class, name) {
	...
	output += '		<div class="input-group col-xs-6" style="float:left">';
	output += '			<input type="text" seat="'+data_field+'" id="' + _id + '" name="' + name + '" disabled class="form-control input-number seat-place' + _class + '" value="' + value + '">';
	output += '		</div>';
	output += '		<div class="input-group col-xs-6" style="float:left">';
	output += '			<input type="text" seat="'+data_field+'" id="' + _id + '" name="' + name + '" disabled class="form-control input-number seat-value' + _class + '" value="' + value2 + '">';
	output += '		</div>';
	output += '	</div>';
	output += '</div>';
