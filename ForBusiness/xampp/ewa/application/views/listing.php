						...
						<div id="collapse2" class="panel-collapse collapse">
							<div class="panel-body listing-menu-content">
								...
								?>
									...
									<input <?php echo $filter_checked; ?> type="checkbox" onclick="window.location.href='<?php echo base_url()."listing". $get_string; ?>'" value=""><?php echo $this->googletranslate->translate($_SESSION["language_code"], $category); ?>
									</label></div></td></tr>
								<?php
									}
								?>
					...
					<div class="panel panel-default">
						...
						<div id="collapse3" class="panel-collapse collapse">
							<div class="panel-body listing-menu-content">
								...
								?>
									<tr><td><div class="checkbox"><label>
									<input <?php echo $filter_checked; ?> type="checkbox" onclick="window.location.href='<?php echo base_url()."listing". $get_string; ?>'" value=""><?php echo $this->googletranslate->translate($_SESSION["language_code"], $destination); ?>
									</label></div></td></tr>
								<?php
									}
								?>
					...
					<div class="panel panel-default">
						...
						<div id="collapse4" class="panel-collapse collapse">
							<div class="panel-body listing-menu-content">
								...
								?>
									<tr><td><div class="checkbox"><label>
									<input <?php echo $filter_checked; ?> type="checkbox" onclick="window.location.href='<?php echo base_url()."listing". $get_string; ?>'" value=""><?php echo $this->googletranslate->translate($_SESSION["language_code"], $city); ?>
									</label></div></td></tr>
								<?php
									}
								?>
						...
						<div id="collapse5" class="panel-collapse collapse">
							<div class="panel-body listing-menu-content">
								<table class="table">
									...
									?>
										<tr><td><div class="checkbox"><label>
										<input <?php echo $filter_checked; ?> type="checkbox" onclick="window.location.href='<?php echo base_url()."listing". $get_string; ?>'" value=""><?php echo $this->googletranslate->translate($_SESSION["language_code"], $language); ?>
										</label></div></td></tr>
									<?php
										}
									?>
			...
			<div class="listing-box clearfix bordershadow" style="width:100%;">
				<div class="col-lg-12 nomarginpadding">
					...
					<div class="pull-left job_listing-entry-desc text-left">
						...
						<?php 
							if( $row["u_estimdur"] > 0 ) {
							?>
								<p style="color:#ffffff; margin-bottom: 0;"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Duration'); ?>: <?php echo $row["u_estimdur"] . ' ' .$this->googletranslate->translate($_SESSION["language_code"], $row["u_estidurt"]);?></p>
							<?php
							}
						?>
						<div class="btns_info job_listing-entry-info">
							<?php 
								if( $row["u_advprice"] > 0 ) {
								?>
									<li class="text-left" style="color:#86754d; font-size: 14px;"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'From'); ?> <span style="color:#ffffff; font-size:20px;"><?php echo $this->currency->valor($row["u_advprice"]); ?><i class="fa"><?php echo $_SESSION["i"];?></i></span></li>
								<?php
								}
							?>
						</div>
				...
				<div class="btns_info">
					<a class="" href="<?php echo base_url() . 'product/' . $row["u_sefurl"]; ?>">
						<div class="tourBtn tourBtn1 btn-list"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'BOOK NOW'); ?></div>
					</a>
				</div>
			</div>
		</div>
