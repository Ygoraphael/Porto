...
<script src="/inqdemo/templates/<?php echo $this->template ?>/tinymce/js/tinymce/tinymce.min.js" type="text/javascript"></script>
<!--<script src="/inqdemo/templates/<?php echo $this->template ?>/tinymce/js/global.js" type="text/javascript"></script>-->
