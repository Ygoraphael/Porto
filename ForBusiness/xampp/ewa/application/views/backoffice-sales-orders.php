    ...
    <div class="row setup-content">
        <div class="col-xs-12">
            <div class="col-md-12 well text-center">
                ...
                <table id="tab-po" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th data-name="<?php
                            $_SESSION['fields'] = null;
                            $i = 0;
                            $_SESSION['fields'][$i] = $this->translation->Translation_key("Client Name", $_SESSION['lang_u']);
                            ?>"id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Client Name", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Agent No", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Agent No", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Agent Name", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Agent Name", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Origin", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Origin", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Qtt", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>">Qtt</th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Product Name", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Product Name", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Unit Price Avg", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Unit Price Avg", $_SESSION['lang_u']); ?>.</th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Total Sales", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Total Sales", $_SESSION['lang_u']); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <th></th>
                            <th class="text-center" id="total_avg"><?php echo $this->translation->Translation_key("Total Sales", $_SESSION['lang_u']); ?></th>
                            <th class="text-center" id="total_sales"><?php echo $this->translation->Translation_key("Total Sales", $_SESSION['lang_u']); ?></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
...
?>
    ...
    function atualiza_tabela()
    {
        ...
        jQuery.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>backoffice/ajax/get_sales",
            data: {
