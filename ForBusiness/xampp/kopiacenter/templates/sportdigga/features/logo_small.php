...
class GantryFeaturelogo_small extends GantryFeature {
    var $_feature_name = 'logo_small';
    ...
    function render($position) {
        ...
        <div class="rt-block logo-block-small">
            <a href="<?php echo $gantry->baseUrl; ?>" id="rt-logo-small"><img id="rt-logo-small-img" alt="" src="<?php echo $gantry->baseUrl; ?>templates/<?php echo $gantry->getCurrentTemplate(); ?>/images/logo/logo-small.png" alt=""/></a>
        </div>
        <?php
        return ob_get_clean();
    }
