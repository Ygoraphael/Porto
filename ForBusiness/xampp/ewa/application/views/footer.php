...
?>
	...
	<script src="<?php echo base_url(); ?>js/jquery.hoverdir.js"></script>
	<script src="<?php echo base_url(); ?>js/jquery.hoverex.min.js"></script>
	<script src="<?php echo base_url(); ?>js/jquery.prettyPhoto.js"></script>
	<script src="<?php echo base_url(); ?>js/jquery.isotope.min.js"></script>
	<script src="<?php echo base_url(); ?>js/custom.js"></script>
	<script src="<?php echo base_url(); ?>js/bootstrap-formhelpers.js"></script>
	<script src="<?php echo base_url(); ?>js/jquery.bsAlerts.min.js"></script>
