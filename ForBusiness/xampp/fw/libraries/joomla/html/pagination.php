...
class JPagination extends JObject
{
	...
	public function getPagesLinks()
	{
		...
		$data->start->text = "<b style='font-size:20px;'><<</b>";
		$data->previous->text = "<b style='font-size:20px;'><</b>";
		$data->next->text = "<b style='font-size:20px;'>></b>";
		$data->end->text = "<b style='font-size:20px;'>>></b>";
	...
	protected function _list_render($list)
	{
		...
		$html = '<ul class="myPagination">';
		$html .= '<li class="page gradient">' . $list['previous']['data'] . '</li>';
		foreach ($list['pages'] as $page)
		{
			$html .= '<li class="page gradient">' . $page['data'] . '</li>';
		}
		$html .= '<li class="page gradient">' . $list['next']['data'] . '</li>';
		$html .= '</ul>';
	...
	protected function _item_active(&$item)
	{
		...
		if ($app->isAdmin())
		{
			if ($item->base > 0)
			{
				return "<a style='margin:5px;font-size:20px;' title='' onclick=\"document.adminForm." . $this->prefix . "limitstart.value=" . $item->base
					. "; Joomla.submitform();return false;\">" . $item->text . "</a>";
			}
			else
			{
				return "<a style='margin:5px;font-size:20px;' title='' onclick=\"document.adminForm." . $this->prefix
					. "limitstart.value=0; Joomla.submitform();return false;\">" . $item->text . "</a>";
			}
		}
		else
		{
			return "<a style='margin:5px;font-size:20px;' title=\"" . $item->text . "\" href=\"" . $item->link . "\" class=\"pagenav\">" . $item->text . "</a>";
		}
	}
	...
	protected function _item_inactive(&$item)
	{
		...
		if ($app->isAdmin())
		{
			return "<span style='margin:5px;font-size:20px;'>" . $item->text . "</span>";
		}
		else
		{
			return "<span style='margin:5px;font-size:20px;' class=\"pagenav\">" . $item->text . "</span>";
		}
	}
