...
public class RunnableThread implements Runnable {
    ...
    public static void setOutput(String message) 
    {
        ...
        prototype_sync.PHC_websyncView.jTextArea1.setText(old_message + message + "\n");
...
//            }
    ...
    public void marca_inicio_PHC() throws SQLException {
        config = new Config();
        Diversos diversos = new Diversos( config.getDbHost(), config.getDbInstance(), config.getDbPort(), config.getDbUser(), config.getDbPass(), config.getDb());
        diversos.setInicio();
    }
