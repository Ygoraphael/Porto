...
if ($this->print) {
    ...
    <?php if ($this->order_list_link) { ?>
                    <div class="width100" style="border-bottom: 1px solid rgba(0, 0, 0, 0.1); text-align:left">
                        <a href="<?php echo $this->order_list_link ?>" rel="nofollow" style="font-size:18px;width:100%"><i class="fa fa-th-list" aria-hidden="true" style="margin-right:2%;"></i><?php echo JText::_('COM_VIRTUEMART_ORDERS_VIEW_DEFAULT_TITLE'); ?></a>
                    </div>
                </div>
                <div class="col-md-1"></div>
            </div>
