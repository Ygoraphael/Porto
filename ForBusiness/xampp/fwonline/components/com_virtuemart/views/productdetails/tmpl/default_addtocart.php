...
<div class="addtocart-area" align="right">
    <form method="post" class="product js-recalculate" action="<?php echo JRoute::_('index.php', false); ?>">
        ...
        if (!VmConfig::get('use_as_catalog', 0)) {
            ...
            <div class="addtocart-bar" style="clear:both; width:100%">
    ...
    <div class="clear"></div>
    <br>
    <h4 style="text-align:right; margin-left:90px; font-size:12px;"><?php echo JText::_('IVAPreco'); ?></h4>
</div>
