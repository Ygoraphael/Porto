	...
	<div class="col-lg-12 nomarginpadding">
		<div class="panel-group listing-menu" id="accordion2">
			<div class="panel panel-default">
				<div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion2" href="#collapse2"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Categories'); ?></a></h4></div>
				<div id="collapse2" class="panel-collapse collapse ">
					<div class="panel-body listing-menu-content">
						...
						?>
							...
							<input <?php echo $filter_checked; ?> type="checkbox" onclick="window.location.href='<?php echo base_url() . 'wl/' . $op ."/listing". $get_string; ?>'" value=""></label><?php echo $category; ?>
							</div></td></tr>
						<?php
							}
						?>
		...
		<div class="panel-group listing-menu" id="accordion3">
			<div class="panel panel-default">
				<div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion3" href="#collapse3"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Destinations - Country'); ?></a></h4></div>
				<div id="collapse3" class="panel-collapse collapse ">
					<div class="panel-body listing-menu-content">
						...
						?>
							<tr><td><div class="checkbox"><label>
							<input <?php echo $filter_checked ="checked"; ?> type="checkbox" onclick="window.location.href='<?php echo base_url() . 'wl/' . $op ."/listing". $get_string; ?>'" value=""></label><?php echo $destination; ?>
							</div></td></tr>
						<?php
							}
			...
			<div class="panel panel-default">
				<div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion4" href="#collapse4"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Destinations - City'); ?></a></h4></div>
				<div id="collapse4" class="panel-collapse collapse">
					<div class="panel-body listing-menu-content">
						...
						?>
							<tr><td><div class="checkbox"><label>
							<input <?php echo $filter_checked; ?> type="checkbox" onclick="window.location.href='<?php echo base_url() . 'wl/' . $op ."/listing". $get_string; ?>'" value=""></label><?php echo $city; ?>
							</div></td></tr>
						<?php
							}
						?>
		...
		<div class="panel-group listing-menu" id="accordion5">
			<div class="panel panel-default">
				<div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion5" href="#collapse5"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Languages'); ?></a></h4></div>
				<div id="collapse5" class="panel-collapse collapse ">
					<div class="panel-body listing-menu-content">
						<table class="table">
							...
							?>
								<tr><td><div class="checkbox"><label>
								<input <?php echo $filter_checked; ?> type="checkbox" onclick="window.location.href='<?php echo base_url() . 'wl/' . $op ."/listing". $get_string; ?>'" value=""></label><?php echo $language; ?>
								</div></td></tr>
							<?php
								}
							?>
		...
		<div class="panel-group listing-menu" id="accordion6">
			<div class="panel panel-default">
				<div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion6" href="#collapse6"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Duration'); ?></a></h4></div>
				<div id="collapse6" class="panel-collapse collapse ">
					<div class="panel-body listing-menu-content">
						...
						?>
							<tr><td><div class="checkbox"><label>
							<input <?php echo $filter_checked; ?> type="checkbox" onclick="window.location.href='<?php echo base_url() . 'wl/' . $op ."/listing". $get_string; ?>'" value=""></label><?php echo $duration; ?>
							</div></td></tr>
						<?php
							}
						?>
...
?>
	<div class="btn-group clearfix" style='margin-bottom:15px;'>
		...
		<a onclick="window.location.href='<?php echo base_url()."wl/".$op."/listing". $get_string;  ?>'" id="" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-th-list"></span><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'List'); ?></a>
		<?php $get_string = $this->urlparameters->ArrayUrlChangeParameter($this->input->get(NULL, TRUE), 'list', 'grid'); ?>
		<a onclick="window.location.href='<?php echo base_url()."wl/".$op."/listing". $get_string;  ?>'" id="" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-th"></span><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Grid'); ?></a>
	</div>
	...
	<div class="col-sm-6 col-md-4 col-lg-3 mt-4 boxhover">
		...
		<div class="box-wrapper">
			...
			<div class="box-content">
				...
				<div class="desc"><?php if( $row["u_estimdur"] > 0 ) { ?> <?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Duration'); ?>: <?php echo $row["u_estimdur"] . ' ' .$this->googletranslate->translate($_SESSION["language_code"], $row["u_estidurt"]); } ?></div>
				<span class="price"><?php echo $this->currency->valor($row["u_advprice"]);?> <i class="fa"><?php echo $_SESSION["i"];?></i></span>
				<div class="footer">
					<a href="<?php echo base_url(); ?>wl/<?php echo $op; ?>/product/<?php echo $row["u_sefurl"];?>"class="btn fifth"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'BOOK NOW'); ?></a>
				</div>
			</div>
		</div>
	</div>
            ...
            <div class="thumbnail">
                ...
                <div class="caption" >
                    ...
                    <p class="group inner list-group-item-text">
                        <?php if( $row["u_estimdur"] > 0 ) { ?> <?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Duration'); ?>: <?php echo $row["u_estimdur"] . ' ' . $row["u_estidurt"]; } ?><br/>	
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12 capbook">
                            <p class="lead">
								...
								From <?php echo $this->currency->valor($row["u_advprice"]);?> <i class="fa"><?php echo $_SESSION["i"];?></i>
								<?php } ?>
							</p>
                        </div>
                        <div class="col-xs-12 col-md-12 btnbook" style="">
                            <a class="btn btn-success" href="<?php echo base_url(); ?>wl/<?php echo $op; ?>/product/<?php echo $row["u_sefurl"];?>"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'BOOK NOW'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
