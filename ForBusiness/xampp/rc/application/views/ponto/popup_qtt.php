    ...
    <body>
		<div class="col-lg-10 main-page">
				<div class="stats-ponto4 ">
					...
					<form action="<?php echo base_url(); ?>ponto/add_product" method="POST">
					<div class="input-group">
					  ...
					  <input type="text" name="qtt" class="form-control input-number" value="1" min="1" max="999" pattern="[0-9]*" required>
					  <span class="input-group-btn">
					...
					<input type="hidden" name="stfamistamp"  value="<?php echo $stfamistamp; ?>" >
