		...
		<div id="tarefas_all" >
			<div class=" table-responsive col-md-10 col-md-offset-1">
                <table class="table table-bordered table-hover mb-0" style=" background-color: white;">
					...
					<tr>
						<td>
						<form action="<?php echo base_url(); ?>ponto/product_dytable" method="POST">
							<div class="col-lg-12">
								<?php 
						...
						<div class="col-lg-12">
							...
							foreach ($produtos as $produto): ?>
								<div class="col-lg-12 box_hover" >
									<div class="bopper2">
										<p> <?php echo $produto["campo"]; ?></p>
										<input type="hidden" name="dytablestamp"  value="<?php echo $produto["dytablestamp"]; ?>">
									</div>
								</div>
							<?php endforeach; ?>
						</div>
