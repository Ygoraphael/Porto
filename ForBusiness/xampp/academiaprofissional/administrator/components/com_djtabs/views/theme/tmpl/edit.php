		...
		<div class="span12 form-horizontal">
			<fieldset class="adminform">	
				<ul class="nav nav-tabs">
					...
					<li>
						<a href="#attributes" data-toggle="tab"><?php echo JText::_('COM_DJTABS_ATTRIBUTES');?></a>
						<a href="#attributes" data-toggle="tab" 
						style="width:16px;height:16px;margin:0;border:0;padding:0;position:absolute;left:355px;top:47px;cursor:pointer;" 
						title="¿" id="test" onclick="randomize();" >
						<canvas id="djcanvas" width="14" height="14" style="border:1px solid #d3d3d3;">
						</canvas></a>
					</li>
				</ul>
					<div class="tab-content">
						<div class="tab-pane active" id="details">
							...
							<div class="control-group">
								<div class="control-label"><?php echo $this->form->getLabel('random'); ?></div>
								<div class="controls">		                			
		                    		<?php echo $this->form->getInput('random'); ?>						
								</div>
							</div>
							<div class="control-group">
						...
						<div class="tab-pane" id="attributes" style="transition: width 2s;">
