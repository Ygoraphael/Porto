...
class Order_model extends CI_Model {
    ...
    function get ( $last_order ) 
	{
		...
		select 
			...
			customer_note obs,
			created_on dataobra, 
			IFNULL((select company from d2e0b_virtuemart_order_userinfos where d2e0b_virtuemart_orders.virtuemart_order_id = virtuemart_order_id and address_type = 'BT' limit 1), '') nome,
			...
			IFNULL((select company from d2e0b_virtuemart_order_userinfos where d2e0b_virtuemart_orders.virtuemart_order_id = virtuemart_order_id and address_type = 'ST' limit 1), '') nome_entrega,
