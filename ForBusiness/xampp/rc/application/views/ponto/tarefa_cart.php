    ...
    <ul>
        ...
        <?php foreach ($temp as $t): ?>
            <li class="row">
                ...
                <span class="remove"><button type="button" onclick="window.location.href = '<?php echo base_url(); ?>ponto/delete_tmp_tarefa2/<?php echo $t['ststamp'];?>'"class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i></button></span>
            </li>
        <?php  endforeach; ?>
    </ul>
</div>