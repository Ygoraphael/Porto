...
public class Encomenda extends Db {
   ...
   public boolean save(Config conf) throws SQLException, ParseException 
   {
        ...
        bo.nome = this.nome;
        bo.ncont = this.ncont;
        bo.morada = this.morada;
        bo.codpost = this.codpost;
        bo.local = this.local;
        bo.pais_origem = this.pais_origem;
        bo.email = this.email;
        bo.telefone = this.telefone;
        
        bo.nome_entrega = this.nome_entrega;
        bo.morada_entrega = this.morada_entrega;
        bo.local_entrega = this.local_entrega;
        bo.telefone_entrega = this.telefone_entrega;
        bo.pais_origem_entrega = this.pais_origem_entrega;
        bo.codpost_entrega = this.codpost_entrega;
        
        bo.edescc = this.edescc;
        bo.etotal = this.etotal;
        bo.etotaldeb = this.etotaldeb;

        bo.tpdesc = this.pagamento;
        bo.envio = this.envio;
