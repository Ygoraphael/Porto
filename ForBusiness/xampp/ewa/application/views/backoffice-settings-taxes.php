...
<div class="page-head col-md-12">
	<div class="col-md-12 col-sm-12">
		...
		<button type="button" id="create_tax" class="btn btn-info pull-right"><?php echo $this->translation->Translation_key("Create Tax/Fee", $_SESSION['lang_u']); ?></button>
	</div>
</div>
	...
	<table id="tab-users" class="table table-striped table-bordered" cellspacing="0" width="100%">
		<thead>
			<tr>
				...
				<th><?php echo $this->translation->Translation_key("Formula", $_SESSION['lang_u']); ?></th>
				<th></th>
				<th></th>
			</tr>
		</thead>
