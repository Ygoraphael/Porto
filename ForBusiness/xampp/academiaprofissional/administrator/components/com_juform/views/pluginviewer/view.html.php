...
class JUFormViewPluginViewer extends JUFMViewAdmin
{
	...
	{
		JToolBarHelper::title(JText::_('COM_JUFORM_PAGE_PLUGIN_VIEWER'), 'plugin-viewer');
	...
	protected function setDocument()
	{
		...
		$script   = "
					Joomla.submitbutton = function (task) {
						if (task == 'pluginviewer.cancel' || document.formvalidator.isValid(document.getElementById("adminForm"))) {
