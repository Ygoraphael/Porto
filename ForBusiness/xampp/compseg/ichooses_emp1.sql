...
--
-- Base de Dados: `ichooses_emp1`
--
CREATE DATABASE IF NOT EXISTS `ichooses_emp1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ichooses_emp1`;
...
-- Procedures
--
CREATE DEFINER=`cpses_ic35ckotq3`@`localhost` PROCEDURE `GenerateSafetyWalkNotifications`(IN `qtd_` INT(11), IN `iduser_` INT(11), IN `idsafetywalk_` INT(11), IN `datelimit_` DATETIME)
BEGIN
	DECLARE x INT;
...
CREATE DEFINER=`cpses_ic35ckotq3`@`localhost` PROCEDURE `GenerateSecurityDialogNotifications`(IN `iduser_` INT(11), IN `idSecurityDialog_` INT(11), IN `idSecurityDialogWeek_` INT(11), IN `week_` INT(11), IN `year_` INT(11))
BEGIN
	insert into Notification (user, table1, value1, date_limit, title, description, created_at, type) 
	VALUES (
		iduser_,
...
CREATE DEFINER=`cpses_ic35ckotq3`@`localhost` PROCEDURE `GenerateSurveyNotifications`(IN `qtd_` INT(11), IN `iduser_` INT(11), IN `idsurvey_` INT(11), IN `datelimit_` DATETIME)
BEGIN
	DECLARE x INT;
...
CREATE DEFINER=`cpses_ic35ckotq3`@`localhost` PROCEDURE `ManageSafetyWalkNotifications`(IN `tipo` INT(11))
BEGIN
...
CREATE DEFINER=`cpses_ic35ckotq3`@`localhost` PROCEDURE `ManageSecurityDialogNotifications`(IN `tipo` INT(11))
BEGIN
	DECLARE done BOOLEAN DEFAULT FALSE;
	DECLARE _idUser BIGINT UNSIGNED;
	...
	(
		...
		where 
			...
			sdw.week = WEEK(NOW()) and sdw.year = YEAR(NOW()) and sdw.last_notification IS NULL
	);
	DECLARE CONTINUE HANDLER FOR NOT FOUND SET done := TRUE;
...
CREATE DEFINER=`cpses_ic35ckotq3`@`localhost` PROCEDURE `ManageSurveyNotifications`(IN `tipo` INT(11))
BEGIN
	DECLARE done BOOLEAN DEFAULT FALSE;
	DECLARE _idUser BIGINT UNSIGNED;
...
INSERT INTO `category` (`idCategory`, `name`, `status`, `created_at`, `deleted_at`, `deleted`) VALUES
(1, 'NA', 1, '2017-10-02 10:43:48', NULL, 0),
(2, 'Condições', 1, '2017-10-02 10:43:48', NULL, 0),
(3, 'Equipamento e Proteção Individual (EPI)', 1, '2017-10-02 10:43:48', NULL, 0),
(4, 'Práticas e Comportamentos', 1, '2017-10-02 10:43:48', NULL, 0),
(5, 'Práticas Específicas', 1, '2017-10-02 10:43:48', NULL, 0);
...
INSERT INTO `config` (`idConfig`, `name`, `created_at`, `deleted_at`, `deleted`) VALUES
(1, 'Dummy', NULL, NULL, 0);
...
--
-- Extraindo dados da tabela `factory`
--

INSERT INTO `factory` (`idFactory`, `name`, `status`, `created_at`, `deleted_at`, `deleted`) VALUES
(1, 'Porto', 1, '2017-10-02 11:43:45', NULL, 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `factoryuser`
--

CREATE TABLE IF NOT EXISTS `factoryuser` (
...
--
-- Estrutura da tabela `insecurity`
--

CREATE TABLE IF NOT EXISTS `insecurity` (
...
INSERT INTO `monitor` (`idMonitor`, `description`, `created_at`, `deleted_at`, `deleted`) VALUES
(1, 'Monitor de Qualidade', '2017-10-02 10:43:49', NULL, 0),
(2, 'Monitor de Quantidade', '2017-10-02 10:43:49', NULL, 0);
...
INSERT INTO `profile` (`idProfile`, `name`, `status`, `created_at`, `deleted_at`, `deleted`) VALUES
(1, 'Direção de Fábrica', 1, '2017-10-02 10:43:49', NULL, 0),
(2, 'Direção', 1, '2017-10-02 10:43:49', NULL, 0),
(3, 'Chefia', 1, '2017-10-02 10:43:49', NULL, 0),
(4, 'Operacional', 1, '2017-10-02 10:43:49', NULL, 0),
(5, 'Direção de Segurança', 1, '2017-10-02 10:43:49', NULL, 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `profilemonitor`
--
...
--
-- Extraindo dados da tabela `profilemonitor`
--

INSERT INTO `profilemonitor` (`idProfileMonitor`, `profile`, `monitor`, `status`, `created_at`, `deleted_at`, `deleted`) VALUES
(4, 2, 1, 1, '2017-10-02 11:11:57', NULL, 0),
(5, 2, 2, 1, '2017-10-02 11:11:57', NULL, 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `safetywalk`
--

CREATE TABLE IF NOT EXISTS `safetywalk` (
...
--
-- Estrutura da tabela `safetywalkanswer`
--
...
--
-- Estrutura da tabela `safetywalkanswerquestion`
--
...
--
-- Estrutura da tabela `safetywalkquestion`
--
...
INSERT INTO `sector` (`idSector`, `name`, `status`, `factory`, `created_at`, `deleted_at`, `deleted`) VALUES
(1, 'WC', 1, 1, '2017-10-02 11:44:19', NULL, 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `sectoruser`
--

CREATE TABLE IF NOT EXISTS `sectoruser` (
...
--
-- Estrutura da tabela `securitydialog`
--

CREATE TABLE IF NOT EXISTS `securitydialog` (
...
--
-- Estrutura da tabela `securitydialogweek`
--

CREATE TABLE IF NOT EXISTS `securitydialogweek` (
  ...
  KEY `FK_SecurityDialogWeek_SecurityDialog` (`securitydialog`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Estrutura da tabela `surveyanswer`
--
...
--
-- Estrutura da tabela `surveyanswerquestion`
--
...
--
-- Estrutura da tabela `surveyquestion`
--
...
--
-- Estrutura da tabela `usercompany`
--
...
--
-- Limitadores para a tabela `factoryuser`
--
ALTER TABLE `factoryuser`
  ADD CONSTRAINT `FK_FactoryUser_Factory` FOREIGN KEY (`factory`) REFERENCES `factory` (`idFactory`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_FactoryUser_User` FOREIGN KEY (`user`) REFERENCES `usercompany` (`idUserCompany`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `sector`
--
ALTER TABLE `sector`
  ADD CONSTRAINT `FK_Sector_Factory` FOREIGN KEY (`factory`) REFERENCES `factory` (`idFactory`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `sectoruser`
--
ALTER TABLE `sectoruser`
  ADD CONSTRAINT `FK_SectorUser_Sector` FOREIGN KEY (`sector`) REFERENCES `sector` (`idSector`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK__User` FOREIGN KEY (`user`) REFERENCES `usercompany` (`idUserCompany`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `securitydialogweek`
--
ALTER TABLE `securitydialogweek`
  ADD CONSTRAINT `FK_SecurityDialogWeek_SecurityDialog` FOREIGN KEY (`securitydialog`) REFERENCES `securitydialog` (`idSecurityDialog`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `surveyanswerquestion`
--
ALTER TABLE `surveyanswerquestion`
  ADD CONSTRAINT `FK_SurveyAnswerQuestion_SurveyQuestion` FOREIGN KEY (`survey_question`) REFERENCES `surveyquestion` (`idSurveyQuestion`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `surveyquestion`
--
ALTER TABLE `surveyquestion`
  ADD CONSTRAINT `FK_SurveyQuestion_Category` FOREIGN KEY (`category`) REFERENCES `category` (`idCategory`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_SurveyQuestion_Survey` FOREIGN KEY (`survey`) REFERENCES `survey` (`idSurvey`) ON DELETE CASCADE ON UPDATE CASCADE;
