...
class DJMediatoolsLayoutHelper extends JObject
{
	...
	public function addScripts(&$params) {
		...
		$document->addScript('https://cdnjs.cloudflare.com/ajax/libs/picturefill/2.3.1/picturefill.min.js', 'text/javascript', $canDefer);
		$document->addScript('components/com_djmediatools/assets/js/powertools-1.2.0.js', 'text/javascript', $canDefer);
		$document->addScript('components/com_djmediatools/layouts/slideshow/js/slideshow.js', 'text/javascript', $canDefer);
		if(file_exists(JPATH_ROOT.DS.'components'.DS.'com_djmediatools'.DS.'layouts'.DS.$this->_prefix.DS.'js'.DS.$this->_prefix.'.js')) {
			$document->addScript('components/com_djmediatools/layouts/'.$this->_prefix.'/js/'.$this->_prefix.'.js', 'text/javascript', $canDefer);
		}
	...
	public function addModal(&$params) {
		...
		$document->addScript(JURI::root(true).'/components/com_djmediatools/assets/js/album.js', 'text/javascript', $canDefer);
