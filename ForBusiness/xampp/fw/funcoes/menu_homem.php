...
if (count($modalidades)) {
    foreach ($modalidades as $modalidade) {
        ...
        if ($lang->getTag() == "en-GB") {
            $ModUrl = "index.php/products/search?Modalidade=" . strtoupper($modalidade["Modalidade"]) . "&Genero=MASCULINO";
        } elseif ($lang->getTag() == "es-ES") {
            $modUrl = "index.php/productos/search?Modalidade=" . strtoupper($modalidade["Modalidade"]) . "&Genero=MASCULINO";
        } else {
            $ModUrl = "index.php/produtos/search?Modalidade=" . strtoupper($modalidade["Modalidade"]) . "&Genero=MASCULINO";
        }
        ?>
            ...
            <div class="clearfix"><p><a href="<?= $ModUrl ?>" class="menuFontTitle menuFontTitleOrange"><b><?= $lang_modalidade ?></b></a></p></div>
                            ...
                            if (count($categorias)) {
                                foreach ($categorias as $categoria) {
                                    ...
                                    if ($lang->getTag() == "en-GB") {
                                        $url = "index.php/products/search?Modalidade=" . strtoupper($modalidade["Modalidade"]) . "&Genero=MASCULINO&Categoria=" . strtoupper($categoria["Categoria"]);
                                    } elseif ($lang->getTag() == "es-ES") {
                                        $url = "index.php/productos/search?Modalidade=" . strtoupper($modalidade["Modalidade"]) . "&Genero=MASCULINO&Categoria=" . strtoupper($categoria["Categoria"]);
                                    } else {
                                        $url = "index.php/produtos/search?Modalidade=" . strtoupper($modalidade["Modalidade"]) . "&Genero=MASCULINO&Categoria=" . strtoupper($categoria["Categoria"]);
                                    }
                                    ?>
