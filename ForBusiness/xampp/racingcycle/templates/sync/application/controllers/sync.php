	...
	public function artigos() 
	{
		...
		foreach ( $products as $product ) 
		{
			...
			if ( $prod->exists == 1 ) 
			{
				...
				{
					$prod->attach_price( strtoupper($product->epv1), 1);
					$prod->attach_price( strtoupper($product->epv2), 2);
					$prod->attach_price( strtoupper($product->epv3), 3);
					$prod->attach_price( strtoupper($product->epv4), 4);
					$prod->attach_price( strtoupper($product->epv5), 5);
