...
<div class="buttonBar-right" style="margin-bottom:5px;">

<button name="setpayment" class="button button-caution" type="submit"><?php echo JText::_('COM_VIRTUEMART_SAVE'); ?></button>
     &nbsp;
   <?php   if ($this->layoutName!='default') { ?>
<button class="button button-caution" type="reset" onClick="window.location.href='<?php echo JRoute::_('index.php?option=com_virtuemart&view=cart'); ?>'" ><?php echo JText::_('COM_VIRTUEMART_CANCEL'); ?></button>
	<?php  } ?>
    </div>
