...
<div class="page-head col-md-12">
    <div class="col-md-12 col-sm-12">
        ...
        <button type="button" id="access_maintenance" style="margin-left:15px" class="btn btn-info pull-right"><?php echo $this->translation->Translation_key("Access's Maintenance", $_SESSION['lang_u']); ?></button>
        <?php if ($create_user) { ?>
            <button type="button" id="create_user" class="btn btn-info pull-right"><?php echo $this->translation->Translation_key("Create user", $_SESSION['lang_u']); ?></button>
        <?php } ?>
    </div>
</div>
...
<div class="main-content col-sm-12">
    <table id="tab-users" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th><?php echo $this->translation->Translation_key("Sub-ID", $_SESSION['lang_u']); ?></th>
