...
if ($showNextPrevBtn)
{
	...
	$registry->set('onclick', 'JUFormNextPage(this, ' . $validateChangePage . ');' . $onclick . ' return false;');
	...
	$onclick = $registry->get('onclick', '') ? ' ' . $registry->get('onclick', '') : '';
	$registry->set('onclick', 'JUFormPrevPage(this, ' . $validateChangePage . ');' . $onclick . ' return false;');
