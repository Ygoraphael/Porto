...
class JooDBAdminHelper
{
	...
	public static function getFunctions($context) {
		$functions = array (
		"catalog" => array('loop','pagenav','pagecount','resultcount','nodata','limitbox','searchbox|[fieldlist]','alphabox','checkbox','groupselect|FIELD|[size]','sortlink|FIELD','readon','exportbutton','searchbutton','resetbutton','backbutton','editbutton|[cond]','deletebutton'),
		"single" => array('printbutton','backbutton','nextbutton','prevbutton','editbutton|[cond]'),
		"print" => array(),
