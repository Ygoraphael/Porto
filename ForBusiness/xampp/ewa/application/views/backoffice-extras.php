...
<div class="page-head col-md-12">
	<div class="col-md-12 col-sm-12">
		...
		<a href="<?php echo base_url() . "backoffice/extras_usage"; ?>" type="button" class="btn btn-info pull-right" style="margin-right:15px;"><?php echo $this->translation->Translation_key("Resources Usage", $_SESSION['lang_u']); ?></a>
		<?php } ?>
	</div>
</div>
...
<div class="main-content col-sm-12">
	<div class="col-lg-12">
		...
		<button type="button" id="extra_add" class="btn btn-info btn-lg pull-left"><?php echo $this->translation->Translation_key("ADD EXTRA", $_SESSION['lang_u']); ?></button>
					...
					success: function(data) 
					{
						if( data ) {
							if( data != 0) {
								...
								jQuery(document).trigger("add-alerts", [
								{
									"message": "Sorry, you can not delete an extra that has already been billed.",
									"priority": 'error'
								}
								]);
							}
