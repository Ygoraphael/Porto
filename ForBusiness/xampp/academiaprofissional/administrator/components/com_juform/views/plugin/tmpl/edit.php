...
<script type="text/javascript">
	Joomla.submitbutton = function (task) {
		if (task == 'plugin.cancel' || document.formvalidator.isValid(document.getElementById("adminForm"))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_juform&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'plugin', array('active' => 'details')); ?>
		...
		foreach ($fieldSets AS $fieldSet)
		{
			...
			if ($fields)
			{
				$label = $fieldSet->label ? $fieldSet->label : JText::_('COM_JUFORM_FIELD_SET_' . strtoupper($fieldSet->name));
				echo JHtml::_('bootstrap.addTab', 'plugin', $fieldSet->name, $label);
