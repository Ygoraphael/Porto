...
<div class="billto-shipto">
	<div class="width50 floatleft">
		...
		<div class="clear"></div>
		<a class="button subbutton btn btn-primary" href="<?php echo JRoute::_('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=BT',$this->useXHTML,$this->useSSL) ?>">
	...
	<div class="width50 floatleft">
		...
		<a class="button subbutton btn btn-primary" href="<?php echo JRoute::_('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&virtuemart_user_id[]='.$this->cart->lists['current_id'],$this->useXHTML,$this->useSSL) ?>">
	...
	<table
		...
		<tr>
			...
			<th
				...
				width="140px"><?php echo JText::_('COM_VIRTUEMART_CART_QUANTITY') ?> / <?php echo JText::_('COM_VIRTUEMART_CART_ACTION') ?></th>
		...
		<tr valign="top" class="sectiontableentry<?php echo $i ?>">
			<td align="center" ><?php if ( $prow->virtuemart_media_id) {  ?>
				<?php
...
// 					vmdebug('$this->cart->pricesUnformatted[$pkey]',$this->cart->pricesUnformatted[$pkey]['priceBeforeTax']);
					echo $this->currencyDisplay->createPriceDiv('basePriceWithTax','', $this->cart->pricesUnformatted[$pkey],true,false);
					
					?>
				</td>
			<td align="right" ><a class="vmicon vm2-remove_from_cart" title="<?php echo JText::_('COM_VIRTUEMART_CART_DELETE') ?>" align="middle" href="<?php echo JRoute::_('index.php?option=com_virtuemart&view=cart&task=delete&cart_virtuemart_product_id='.$prow->cart_item_id  ) ?>">
				</a>
		...
		<tr>
		<th class="payment" colspan="4" align="right"><?php echo JText::_('Payment Details'); ?></th>
		<th align="right" width="60px"><?php  echo JText::_('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT') ?></th>
		<th align="right" width="60px"><?php echo JText::_('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT') ?></th>
		<th align="right" width="70px"><?php echo JText::_('COM_VIRTUEMART_CART_TOTAL') ?></th>
		...
		<tr class="sectiontableentry2">
			<td colspan="4" align="left"><?php if(!empty($this->layoutName) && $this->layoutName=='default') {
		...
		<tr class="sectiontableentry1">
			...
			<td colspan="4" align="left"><?php echo $this->cart->cartData['shipmentName']; ?>
				<br />
				<?php
		...
		<tr class="sectiontableentry1">
			...
			<td colspan="4" align="left"><?php echo $this->cart->cartData['paymentName']; ?>
				<br />
