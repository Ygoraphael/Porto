...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
	...
	<tr>
		<td colspan="2">
			...
			<?php
				$pieces = explode("/", JURI::base());
			?>
			<strong>Encomenda <a href='<?php echo $pieces[2].JRoute::_('index.php?option=com_virtuemart&view=orders&layout=details&order_number='.$this->orderDetails['details']['BT']->order_number); ?>'>
