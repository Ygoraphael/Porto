            ...
            <div class=" table-responsive col-md-10 col-md-offset-1">
                <table class="table table-bordered table-hover mb-0" style=" background-color: white;">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <form action="<?php echo base_url(); ?>ponto/product_dossier" method="POST">
                                    <div class="col-lg-12">
                                        <?php foreach ($trabalhador as $trabalhadore): ?>
                                    ...
                                    <?php foreach ($produtos as $produto): ?>
                                        <div class="col-lg-12 box_hover" >
                                            <div class="bopper2">
                                                ...
                                                <input type="hidden" name="bistamp"  value="<?php echo $produto["bistamp"]; ?>">
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
