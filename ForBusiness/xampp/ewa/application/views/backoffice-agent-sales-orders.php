						...
						<table id="tab-p" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th><?php echo $this->translation->Translation_key("Operator No", $_SESSION['lang_u']); ?></th>
									<th><?php echo $this->translation->Translation_key("Operator Name", $_SESSION['lang_u']); ?></th>
