...
public class RunnableThread implements Runnable {
    ...
    public static void EnviaEmail() throws IOException {
        ...
        try {
            ...
            message.addRecipient(Message.RecipientType.BCC, new InternetAddress("tiago.loureiro@novoscanais.com"));
            message.setSubject("ERRO SINCRONIZADOR RACINGCYCLE");
            message.setText("Erro ao fazer a sincronização. Verificar sincronizador ou enviar email para tiago.loureiro@novoscanais.com!");
