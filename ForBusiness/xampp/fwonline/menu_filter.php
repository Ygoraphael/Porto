...
if( $modalidade <> '' and $genero == '' and $categoria == '' ) {
	...
	if( $unis ) {
		...
		?>
			<figure class="box1 hvr-grow" onclick="GenChoose('MASCULINO', 'MALE');">
				<img src="<?php echo JURI::base(); ?>imagens/cats/MASCULINO.jpg" alt="MALE"/>
				<figcaption class="figCaptionMan">
					<h4>MALE</h4>
				</figcaption>
			</figure>
			<figure class="box1 hvr-grow" onclick="GenChoose('FEMININO', 'FEMALE');">
		...
		elseif ($lang->getTag() == "es-ES" ) {
			?>
				<figure class="box1 hvr-grow" onclick="GenChoose('MASCULINO', 'HOMBRE');">
					<img src="<?php echo JURI::base(); ?>imagens/cats/MASCULINO.jpg" alt="HOMBRE"/>
					<figcaption class="figCaptionMan">
						<h4>HOMBRE</h4>
					</figcaption>
				</figure>
				<figure class="box1 hvr-grow" onclick="GenChoose('FEMININO', 'MUJER');">
					<img src="<?php echo JURI::base(); ?>imagens/cats/FEMININO.jpg" alt="MUJER"/>
					<figcaption class="figCaptionMan">
						<h4>MUJER</h4>
					</figcaption>
				</figure>
		...
		?>
			<figure class="box1 hvr-grow" onclick="GenChoose('MASCULINO', 'MASCULINO');">
				<img src="<?php echo JURI::base(); ?>imagens/cats/MASCULINO.jpg" alt="MASCULINO"/>
				<figcaption class="figCaptionMan">
					<h4>MASCULINO</h4>
				</figcaption>
			</figure>
			<figure class="box1 hvr-grow" onclick="GenChoose('FEMININO', 'FEMININO');">
