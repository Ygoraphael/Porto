	...
	<div class="jufm-captcha pull-left">
		...
		<div class="input-group">
			<input type="text" id="<?php echo $this->getId(); ?>" name="<?php echo $this->getName(); ?>"
			       class="security_code form-control" autocomplete="off" <?php echo $this->getValidateData(); ?>/>
			<span class="input-group-addon btn btn-default reload-captcha" title="<?php echo JText::_('COM_JUFORM_RELOAD_CAPTCHA'); ?>"><i
