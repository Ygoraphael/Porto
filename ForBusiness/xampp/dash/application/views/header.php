<head>
    ...
    <link rel='stylesheet' href="<?= base_url() ?>css/effectstyle.css" type='text/css' />
    ...
    <script src="<?= base_url() ?>js/jquery.serialize-object.js"></script>
    <script src="<?= base_url() ?>js/modernizr.js"></script>
    <script src="<?= base_url() ?>js/effectmain.js"></script>
