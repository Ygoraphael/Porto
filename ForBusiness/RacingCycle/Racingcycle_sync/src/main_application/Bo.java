    ...
    {    
        ...
        try {
            ...
            for( Encomenda_linha oi : this.orderItems ) {
                ...
                bi.bostamp = checkPelicas(this.bostamp);
                bi.ref = checkPelicas(oi.ref);
                bi.design = checkPelicas(oi.design);
                bi.qtt = oi.qtt;
                bi.dataobra = this.dataobra;
                bi.dataopen = this.dataopen;
                bi.local = checkPelicas(this.local);
                bi.morada = checkPelicas(this.morada);
                bi.codpost = checkPelicas(this.codpost);
