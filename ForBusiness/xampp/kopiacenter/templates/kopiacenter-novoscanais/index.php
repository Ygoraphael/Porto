  ...
  <body>
          ...
          <div class="col-sm-9 col-md-9 templatemo_col9">
            ...
            <nav class="mainMenu">
              <ul class="nav">
                ...
                <li><a class="menu" href="#templatemo_about">Sobre Nos</a></li>
                <li><a class="menu" href="#templatemo_contact">Contatos</a></li>
              </ul>
            </nav>
            </div>
          </div>
	...
	<div class="container">
        	...
        	<div class="item project-post">
						...
						<div class="col-xs-12 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p>A cores, preto & branco, pequenos e grandes Formatos,Papel Variado</p>
							</div>
						</div>
					</div> 	
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12">
        	<div class="item project-post">
						...
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p>Apresentaçoes, Digitalizaçoes, Impressao de Grandes Volumes, Fotos</p>
							</div>
						</div>
					</div> 	
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						...
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p>Encadernaçoes, Cortes, Dobragem, Plastificaçao, Agrafos e Furaçao</p>
							</div>
						</div>
					</div> 	
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						...
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p>Em interiror e Exterior. Com Lona, Vinil, Telas, Cartao, Madeira e Papel de Parede</p>
							</div>
						</div>
					</div> 	
        </div>
		<div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						...
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p>Cartoes de Visita, Blocos e Formularios, Papel Timbrado, Envelopes, Folhetos.</p>
							</div>
						</div>
					</div> 	
        </div>
		<div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						...
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p>Faxes, Digitalizaçao Email, Suporte Informatico, Formataçao de documentos</p>
							</div>
						</div>
					</div> 	
        </div>
		<div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						...
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p>Imagem corporativa, Flyers, Cartazes, Reclames Lumin</p>
							</div>
						</div>
					</div> 	
        </div>
   ...
   <!--Footer End-->
    ...
    <div class="templatemo_bottom">
    	<div class="container">
        	<div class="row">
            	<div class="left">Copyright © 2015 <a href="#">KopiaCenter</a></div>
                <div class="right">
