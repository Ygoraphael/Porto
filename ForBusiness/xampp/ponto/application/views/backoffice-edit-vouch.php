...
<div class="clearfix page-head col-md-12">
	<div class="col-md-12 col-sm-12">
		...
		<a onclick="delete_vouch(); return false;" type="button" class="btn btn-default pull-right"	style="margin-right:15px;"><span class="glyphicon glyphicon-trash"></span> DELETE</a>
	</div>
</div>
	...
	<form data-toggle="validator" role="form" action="#" style="border-radius: 0px;" class="form-horizontal group-border-dashed clearfix" novalidate="true">
		<div class="col-lg-12">
			...
			<div class="row setup-content">
				<div class="col-md-12 well text-center" id="details" >
						<span>
							...
							<div class="form-group">
								<label class="col-lg-2 col-sm-3 control-label">Code</label>
							...
							<div class="form-group">
								<label class="col-lg-2 col-sm-3 control-label">Type</label>
								<div class="input-group col-lg-8 col-sm-6">
									<?php $types = array("- %", "- V");?>
							...
							<div class="form-group">
								<label class="col-lg-2 col-sm-3 control-label">Value</label>
								<div class="input-group col-lg-8 col-sm-6">
							...
							<div class="form-group">
								<label class="col-lg-2 col-sm-3 control-label">Validity</label>
								<div class="input-group col-lg-8 col-sm-6">
				...
				<button data-step-control="save" class="btn btn-info btn-lg pull-left">SAVE VOUCHER</button>
