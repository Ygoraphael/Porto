			...
			<div id='inter<?php $tarefa["id"]?>' class='span12 widget yellow' style="margin-left:0">
				<div class='span6' style="margin-left:0">
					...
					<?php
						...
						$sql_string = "SELECT *, (select dbo.UltDataRenovacaoContrato(csup.no)) data_inicial, (select dbo.ProxDataRenovacaoContrato(csup.no)) data_final FROM csup (nolock) WHERE no = " . $tarefa["cliente"];
						$result_phc = mssql__select($sql_string);
					...
					?>
						...
						<a class="quick-button span2" style="margin-left:0; margin-right:5px">
