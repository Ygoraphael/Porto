<?php	
	$sql = "
		select 
			...
			sum(case when year(ft.fdata)=" . (date("Y") - 1) . " then ft.ettiliq + ft.ettiva else 0 end) as 'Ano_1', 	
			sum(case when year(ft.fdata)=" . date("Y") . " then ft.ettiliq + ft.ettiva else 0 end) as 'Ano_2' 
		from ft (NOLOCK) 
...
<div class="box span12 blue" onTablet="span6" onDesktop="span12">
