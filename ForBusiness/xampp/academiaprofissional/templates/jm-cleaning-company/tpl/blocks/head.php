...
})(window,document,'script','dataLayer','GTM-K4NKJ72');</script>
...
$this->addCompiledStyleSheet(JPath::clean(JMF_TPL_PATH.'/less/template.less'), true, JMF_TH_TEMPLATE);
?>
<!-- include libraries(jQuery Wysiwyg) -->

<script src="<?= JURI::base(); ?>templates/<?php echo $this->template ?>/tinymce/js/tinymce/tinymce.min.js" type="text/javascript"></script>
<!--<script src="/templates/<?php echo $this->template ?>/tinymce/js/global.js" type="text/javascript"></script>-->
