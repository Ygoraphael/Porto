...
<div class="col-lg-12">
	...
	<div class="col-lg-12">
		...
		<?php if( $_SESSION['type'] == 'client' ) { ?>
			...
			<div class="col-xs-6 bs-wizard-step disabled">
				<div class="text-center bs-wizard-stepnum"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Step'); ?> 2</div>
				<div class="progress"><div class="progress-bar"></div></div>
				<a href="#" class="bs-wizard-dot"></a>
		...
		<?php } 
			...
			<div class="col-xs-4 bs-wizard-step complete">
				...
				<div class="progress"><div class="progress-bar"></div></div>
				<a href="#" class="bs-wizard-dot"></a>
				<div class="bs-wizard-info text-center"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Client Data'); ?></div>
			</div>
			...
			<div class="col-xs-4 bs-wizard-step disabled">
				<div class="text-center bs-wizard-stepnum"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Step'); ?> 3</div>
				<div class="progress"><div class="progress-bar"></div></div>
				<a href="#" class="bs-wizard-dot"></a>
				<div class="bs-wizard-info text-center"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Confirmation'); ?></div>
			</div>
	...
	<div class="col-lg-12">
			...
			<div class="checkoutCont">
				...
				<?php if( $_SESSION['type'] == 'agent' ) { ?>
					<div class="footerNavWrap clearfix ButStep2 hidden">
						<div onclick="GoToStep(3)" class="btn pull-right btn-fyi"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'CONTINUE'); ?> <span class="glyphicon glyphicon-chevron-right"></span></div>
					...
					<div class="footerNavWrap clearfix ButStep3 hidden">
						...
						<div onclick="GoToStep(2)" class="btn pull-left btn-fyi"><span class="glyphicon glyphicon-chevron-left"></span> <?php echo $this->googletranslate->translate($_SESSION["language_code"], 'GO BACK'); ?></div>
					</div>
				<?php } ?>
				<?php if( $_SESSION['type'] == 'client' ) { ?>
					<div class="footerNavWrap clearfix ButStep2 hidden">
		...
		<div class="row <?php echo ($_SESSION['type'] == 'agent' ) ? "ButStep3" : "ButStep2"; ?>  hidden" style="margin-bottom:15px;">
