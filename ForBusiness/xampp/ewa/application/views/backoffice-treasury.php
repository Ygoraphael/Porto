                ...
                <table id="tab-p" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            ?>"id="<?php echo $i++; ?>" ><?php echo $this->translation->Translation_key("Date", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Product", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Product", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Qtt", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>">Qtt</th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Payment", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Payment", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Dest. Account", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Dest. Account", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Agent", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Agent", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Unit Price", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Unit Price", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Value", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Value", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("EWA Value", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("EWA Value", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Operator Value", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Operator Value", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Agent Value", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Agent Value", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("EWA Balance", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("EWA Balance", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Date", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Operator Balance", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Operator Balance", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Agent Balance", $_SESSION['lang_u']); ?></th>
                            <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Status", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Status", $_SESSION['lang_u']); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
