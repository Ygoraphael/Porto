...
<div class="container">
    <div class="row">
        <div class="col-lg-9 col-xs-12 nomarginpadding">
            <div class="main-content col-sm-12 col-md-12 col-xs-12 nomarginpadding">
                <div class="panel panel-default">
                    <div class="col-sm-12 col-md-12 col-xs-12">
                        <form action="#" class="form-horizontal group-border-dashed clearfix">
                            <br>
                            <div class="form-group">
                                <label class="col-lg-3 col-sm-6 col-md-6 col-xs-12 control-label"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Name'); ?></label>
                                <div class="input-group col-lg-9 col-sm-6 col-md-6 col-xs-12" style="margin-right:10px;">
                                    <input type="text" class="form-control" id="nome_cliente" value="<?php echo $order['nome']; ?>" readonly />
                                </div>
                                <label class="col-lg-3 col-sm-6 col-md-6 col-xs-12 control-label" style="margin-top:12px">Nº <?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Client'); ?> </label>
                                <div class="input-group col-lg-9 col-sm-6 col-md-6 col-xs-12" style="margin-right:10px; margin-top:10px">
                                    <input type="text" class="form-control" id="nome_cliente" value="<?php echo $order['no']; ?>" readonly />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-sm-6 col-md-6 col-xs-12 control-label"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Fiscal Identification'); ?></label>
                                <div class="input-group col-lg-9 col-sm-6 col-md-6 col-xs-12" style="margin-right:10px;">
                                    <input type="text" class="form-control" id="nome_cliente" value="<?php echo $order['ncont']; ?>" readonly />
                                </div>
                                <label class="col-lg-3 col-sm-6 col-md-6 col-xs-12 control-label" style="margin-top:12px"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Address'); ?></label>
                                <div class="input-group col-lg-9 col-sm-6 col-md-6 col-xs-12" style="margin-right:10px; margin-top:10px">
                                    <input type="text" class="form-control" id="nome_cliente" value="<?php echo $order['morada']; ?>" readonly />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-sm-6 col-md-6 col-xs-12 control-label" ><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Postal Code'); ?></label>
                                <div class="input-group col-lg-9 col-sm-6 col-md-6 col-xs-12" style="margin-right:10px;">
                                    <input type="text" class="form-control" id="nome_cliente" value="<?php echo $order['codpost']; ?>" readonly>
                                </div>
                                <label class="col-lg-3 col-sm-6 col-md-6 col-xs-12 control-label" style="margin-top:12px"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Local'); ?></label>
                                <div class="input-group col-lg-9 col-sm-6 col-md-6 col-xs-12" style="margin-right:10px; margin-top:10px">
                                    <input type="text" class="form-control" id="nome_cliente" value="<?php echo $order['local']; ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-sm-6 col-md-6 col-xs-12 control-label" ><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Order Date'); ?></label>
                                <div class="input-group col-lg-9 col-sm-6 col-md-6 col-xs-12" style="margin-right:10px;">
                                    <input type="text" class="form-control" id="nome_cliente" value="<?php echo substr($order['dataobra'], 0, 10); ?>" readonly>
                                </div>
                                <label class="col-lg-3 col-sm-6 col-md-6 col-xs-12 control-label" style="margin-top:12px"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Product'); ?></label>
                                <div class="input-group col-lg-9 col-sm-6 col-md-6 col-xs-12" style="margin-right:10px; margin-top:10px">
                                    <input type="text" class="form-control" id="nome_cliente" value="<?php echo $order['product']; ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-sm-6 col-md-6 col-xs-12 control-label" ><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Status'); ?></label>
                                <div class="input-group col-lg-9 col-sm-6 col-md-6 col-xs-12" style="margin-right:10px;">
                                    <table class="nomarginpadding"><tr><td class="<?php echo $order["class"]; ?> text-center"><span class="label"><?php echo $this->googletranslate->translate($_SESSION["language_code"], $order["ngstatus"]); ?></span></td></tr></table>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-sm-6 col-md-6 col-xs-12 control-label"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Session'); ?></label>
                                <div class="input-group col-lg-9 col-sm-6 col-md-6 col-xs-12" style="margin-right:10px; ">
                                    <input type="text" class="form-control" id="nome_cliente" value="<?php echo substr($order['U_SESSDATE'], 0, 10) . ' / ' . $order['ihour']; ?>" readonly>
                                </div>
                                <label class="col-lg-3 col-sm-6 col-md-6 col-xs-12 control-label" style="margin-top:12px"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Payment type'); ?></label>
                                <div class="input-group col-lg-9 col-sm-6 col-md-6 col-xs-12" style="margin-right:10px; margin-top:10px">
                        ...
                        <div class="table-responsive">
                            <table id="DocLinhas" class="table table-striped dataTable no-footer" role="grid">
                                <thead>
                                    <tr role="row">
                                        <th class="sorting_disabled" rowspan="1" colspan="1" style="width: auto;"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Ref'); ?></th>
