...
<?php $output = '<input name="keyword" id="search" maxlength="'.$maxlength.'" alt="'.$button_text.'" class="searchbox search-autocomplete" style="background: url(\'images/search-icon.png\') no-repeat scroll 190px 8px transparent" type="text" size="'.$width.'" placeholder="'.JText::_('NC_SEARCH').'" />';
