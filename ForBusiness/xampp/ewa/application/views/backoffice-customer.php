...
<div class="clearfix page-head col-md-12">
	<div class="col-md-12 col-sm-12">
		...
		<button  onclick="history.go(-1);" class="btn btn-primary btn-lg pull-right"><span class="glyphicon glyphicon-chevron-left"></span><?php echo $this->translation->Translation_key("BACK", $_SESSION['lang_u']); ?> </button>
	</div>
...
<div class="main-content col-sm-12">
		<form class="form-horizontal">
			<fieldset>
				<!-- Form Name -->
				<legend ><?php echo $this->translation->Translation_key("Personal Information", $_SESSION['lang_u']); ?></legend>
				<!-- Text input-->
				<div class="form-group">
					<label class="col-md-4 control-label" for="First Name"><?php echo $this->translation->Translation_key("First Name", $_SESSION['lang_u']); ?></label>  
					<div class="col-md-6">
				...
				<!-- Text input-->
				<div class="form-group">
					<label class="col-md-4 control-label" for="Last Name"><?php echo $this->translation->Translation_key("Last Name", $_SESSION['lang_u']); ?></label>  
					<div class="col-md-6">
						<div class="input-group col-md-12">
				...
				<!-- Text input-->
				<div class="form-group">
					<label class="col-md-4 control-label" for="Tax identification number"><?php echo $this->translation->Translation_key("Tax identification number", $_SESSION['lang_u']); ?></label>  
					<div class="col-md-6">
						<div class="input-group col-md-12">
				...
				<!-- Text input-->
				<div class="form-group">
					<label class="col-md-4 control-label" for="Date Of Birth"><?php echo $this->translation->Translation_key("Date Of Birth", $_SESSION['lang_u']); ?></label>  
					<div class="col-md-6">
						<div class="input-group col-md-12">
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="Gender"><?php echo $this->translation->Translation_key("Gender", $_SESSION['lang_u']); ?></label>
					<div class="col-md-4"> 
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="Street"><?php echo $this->translation->Translation_key("Invoice Address", $_SESSION['lang_u']); ?></label>  
					<div class="col-md-6">
				...
				<!-- Text input-->
				<div class="form-group">
					<label class="col-md-4 control-label" for="Email Address"><?php echo $this->translation->Translation_key("Phone No", $_SESSION['lang_u']); ?></label>  
					<div class="col-md-6">
						<div class="input-group col-md-12">
				...
				<!-- Text input-->
				<div class="form-group">
					<label class="col-md-4 control-label" for="Email Address"><?php echo $this->translation->Translation_key("Email Address", $_SESSION['lang_u']); ?></label>  
					<div class="col-md-6">
						<div class="input-group col-md-12">
