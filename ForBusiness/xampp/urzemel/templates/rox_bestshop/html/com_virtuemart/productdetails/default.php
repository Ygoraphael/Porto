...
<div class="productdetails-view productdetails">
	...
	?>
    <?php // Product Title   ?>
    <h2 class="title"><?php echo "Product Details" ?></h2>
...
<span class='st_email_hcount' displayText='Email'></span>
	...
	// Product Short Description END
		...
		if (($this->product->product_in_stock - $this->product->product_ordered) < 1) {
			...
			<span class="rox_availability"><?php echo"Stock";?></span>
...
if (VmConfig::get('ask_question', 1) == 1) {
   ...
   <div class="clear"></div>
	...
	<div class="rox_pdetails_tab">
            <ul id="myTab" class="nav nav-tabs">
              <li class="active"><a href="#home" data-toggle="tab"><span class="rox_title"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_DESC_TITLE') ?></span></a></li>
              <li><a href="#profile" data-toggle="tab"><span class="rox_title"><?php echo JText::_ ('COM_VIRTUEMART_REVIEWS') ?></span></a></li>
            </ul>
            <div id="myTabContent" class="tab-content">
              <div class="tab-pane fade in active" id="home">
                <p><?php echo $this->product->product_desc; ?></p>
              </div>
