...
<div class="page-head col-md-12">
	<div class="col-md-12 col-sm-12">
		...
		<button class="btn btn-info pull-right" id="create_location" style="margin-left:15px;"><?php echo $this->translation->Translation_key("CREATE LOCATION", $_SESSION['lang_u']); ?></button>
		<a onclick="window.history.back(); return false;" type="button" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-chevron-left"></span><?php echo $this->translation->Translation_key("BACK", $_SESSION['lang_u']); ?> </a>
	</div>
</div>
