...
(function( factory ){
   ...
   $.extend( altEditor.prototype, {
       ...
       _openEditModal: function ( )
       {
         ...
         {
            columnDefs.push({ title: dt.context[0].aoColumns[i].sTitle, type: dt.context[0].aoColumns[i].type })
         }
          ...
          for (var j in columnDefs) {
            data += "<div class='form-group'><div class='col-sm-10 col-md-10 col-lg-10' style='padding-top:7px;'><label for='" + columnDefs[j].title + "'>" + columnDefs[j].title + ":</label></div><div class='col-sm-10 col-md-10 col-lg-10'><input type='" + columnDefs[j].type + "'  id='" + columnDefs[j].title + "' name='" + columnDefs[j].title + "' placeholder='" + columnDefs[j].title + "' style='overflow:hidden'  class='form-control form-control-sm col-xs-10' value='" + adata.data()[0][j] + "'></div><div style='clear:both;'></div></div>";
          ...
          $('#altEditor-modal').on('show.bs.modal', function() {
            ...
            $('#altEditor-modal').find('.modal-footer').html("<button type='button' data-content='remove' class='btn btn-default' data-dismiss='modal'>Fechar</button>\
               <button type='button' data-content='remove' class='btn btn-primary' id='editRowBtn'>Gravar</button>");
          });
       ...
       _openDeleteModal: function ()
       {
         ...
         for( var i = 0; i < dt.context[0].aoColumns.length; i++ )
         {
          ...
          for (var i in columnDefs) {
            ...
            data += "<div class='form-group'><label for='" + columnDefs[i].title + "'>" + columnDefs[i].title + " : </label><input  type='hidden'  id='" + columnDefs[i].title + "' name='" + columnDefs[i].title + "' placeholder='" + columnDefs[i].title + "' style='overflow:hidden'  class='form-control col-xs-10' value='" + adata.data()[0][i] + "' >" + adata.data()[0][i] + "</input></div>";
 
          }
          data += "</form>";

          $('#altEditor-modal').on('show.bs.modal', function() {
            $('#altEditor-modal').find('.modal-title').html('Remover');
            $('#altEditor-modal').find('.modal-body').html(data);
            $('#altEditor-modal').find('.modal-footer').html("<button type='button' data-content='remove' class='btn btn-default' data-dismiss='modal'>Fechar</button>\
               <button type='button' data-content='remove' class='btn btn-danger' id='deleteRowBtn'>Remover</button>");
          });
       ...
       _deleteRow: function( )
       {
         ...
         var message = '<div class="alert alert-success" role="alert">\
           <strong>Sucesso!</strong> Registo removido.\
         </div>';
       ...
       _openAddModal: function ( )
       {
         ...
         for( var i = 0; i < dt.context[0].aoColumns.length; i++ )
         {
          ...
          for (var j in columnDefs) {
            data += "<div class='form-group'><div class='col-sm-10 col-md-10 col-lg-10' style='padding-top:7px;'><label for='" + columnDefs[j].title + "'>" + columnDefs[j].title + ":</label></div><div class='col-sm-10 col-md-10 col-lg-10'><input type='" + columnDefs[j].type + "'  id='" + columnDefs[j].title + "' name='" + columnDefs[j].title + "' placeholder='" + columnDefs[j].title + "' style='overflow:hidden'  class='form-control  form-control-sm  col-xs-10' value=''></div><div style='clear:both;'></div></div>";
          ...
          $('#altEditor-modal').on('show.bs.modal', function() {
            $('#altEditor-modal').find('.modal-title').html('Adicionar');
            $('#altEditor-modal').find('.modal-body').html(data);
            $('#altEditor-modal').find('.modal-footer').html("<button type='button' data-content='remove' class='btn btn-default' data-dismiss='modal'>Fechar</button>\
               <button type='button' data-content='remove' class='btn btn-primary' id='addRowBtn'>Adicionar</button>");
          });
       ...
       _addRowData: function()
       {
        console.log('add row')
         ...
         var message = '<div class="alert alert-success" role="alert">\
           <strong>Sucesso!</strong> Registo adicionado.\
         </div>';
