		...
		<div class="tab_main">
			<div id="popup" class="modal-box">
				...
				<div class="modal-body">
					<center>
						<button type="submit" class="cp-apply-filters btn btn-danger" onclick="window.location.replace('<?php echo JURI::base(); ?>');"><?php echo JText::_( 'InicioLoja' ); ?></button>
						<button type="submit" class="cp-apply-filters btn btn-danger" onclick="window.location.replace('http://fullwear.pt');"><?php echo JText::_( 'PaginaFullwear' ); ?></button>
					</center>
				</div>
			</div>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
				<tr>
					<td style="border-top:1px solid #F40;">&nbsp;</td>
					<td width="1024" align="center" style="border-top:1px solid #F40;">
						<div style="float:right; width:224px; margin-top:11px;">
							<jdoc:include type="modules" name="position-1" />
						</div>
						<div style="float:right; width:20px; margin-top:11px;"></div>
						<div style="float:right; width:150px; margin-top:11px;">
						...
						<div class="logoi" style="float:right; width:430px; margin-top:11px;">
							<img class="logoi" src="./imagens/layout/logo_fw.jpg"  data-modal-id="popup" />
						</div>
					</td>
					<td style="border-top:1px solid #F40;">&nbsp;</td>
				</tr>
				...
				<tr>
					...
					<td valign="top">
						<table width="100%" border="0" cellspacing="0" cellpadding="12">
							<tr>
								<td bgcolor="#FFFFFF" class="titulo_fundo">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="35">&nbsp;</td>
											<td><span class='titulo2'>
												<jdoc:include type="modules" name="position-2" /></span></td>
										</tr>
									</table>
								</td>
							</tr>
