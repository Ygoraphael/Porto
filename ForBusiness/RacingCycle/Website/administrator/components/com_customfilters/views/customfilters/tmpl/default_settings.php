 ...
 *				licenses.
 * @version $Id: default_advanced.php 2013-8-27 19:44 sakis $
 * @since		1.8.0
 */
...
<div class="bdpopup cf_advacned_settings"
	id="window<?php echo $item->id?>">
	<a id="hide_popup<?php echo $item->id?>" class="hide_popup"></a>
	<h3>
	<?php echo JText::_('COM_CUSTOMFILTERS_ADV_SETTINGS')?>
	</h3>
	<ul class="adminformlist">
		<li class="setting6"><label class="cflabel"
			for="slider_min_value_<?php echo $item->id?>"><?php echo JText::_('COM_CUSTOMFILTERS_SLIDER_MIN_VALUE_LABEL');?>
		...
		<li class="setting6"><label class="cflabel"
			for="slider_max_value_<?php echo $item->id?>"><?php echo JText::_('COM_CUSTOMFILTERS_SLIDER_MAX_VALUE_LABEL');?>
				:</label> <input type="text"
		...
		<li class="setting5 setting6 setting8"><label class="cflabel"
			for="categories_<?php echo $item->id?>"><?php echo JText::_('COM_CUSTOMFILTERS_FILTER_TO_CATEGORIES');?>
				:</label> 
