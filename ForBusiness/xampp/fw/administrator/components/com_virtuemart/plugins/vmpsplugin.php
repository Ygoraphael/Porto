	...
	*/
	...
	protected function getPluginHtml ($plugin, $selectedPlugin, $pluginSalesPrice) {
		...
		if ($pluginSalesPrice) {
			...
			. '<label for="' . $this->_psType . '_id_' . $plugin->$pluginmethod_id . '">' . '<span class="' . $this->_type . '">' .'<i class="fa fa-arrow-right" aria-hidden="true" style="margin-right:0.8vw;font-size:80%;"></i>'. $plugin->$pluginName . $costDisplay . "</span></label>\n"; 
