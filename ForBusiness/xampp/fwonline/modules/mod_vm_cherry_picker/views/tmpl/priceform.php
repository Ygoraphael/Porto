...
if ( $lang->getTag() == "en-GB" )
	echo '<span class="accordion-group-title">'. JText::_('NOVOSCANAIS_PRECO') .'</span>';
else
	echo '</h2><div class="accordion">
  <div class="sign"></div>
	<span class="accordion-group-title"  style="font-size:19px !important;">'. $conf->get('pricetitle') .'</span></div>';

?>

<div class="cp-price-cont panel">
	<br>
<div style="margin-top:10px">
	...
	<?php
		...
		$lang = JFactory::getLanguage();
		if ( $lang->getTag() == "en-GB" )
			echo JText::_('NOVOSCANAIS_DE');
		else
			echo $conf->get('price_from');
	?>
	</span>
	...
	><span class="cp-price-rangelabel cp-price-range-middle">
	<?php
		//tiago hack
		$lang = JFactory::getLanguage();
		if ( $lang->getTag() == "en-GB" )
			echo JText::_('NOVOSCANAIS_ATE');
		else
			echo $conf->get('price_to');
	?>
	</span
	><span class="cp-price-field"
		><span class="cp-price-field-currency"><?php
