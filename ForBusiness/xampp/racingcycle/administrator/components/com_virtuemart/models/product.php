...
// 		return false;
	...
	function getOrderByList ($virtuemart_category_id = FALSE) {
		...
		$orderByList = '
		<div id="sort-by" style="float:left; padding-top:10px;">
			<label class="left">' . JText::_ ('COM_VIRTUEMART_ORDERBY') . ':</label>
			<ul>
				<li style="width:150px;">
					<select class="ordererlist">
		...
		if( strpos($link, 'dirDesc') ) {
			$orderByList .=	'	<a class="button-arrow button-desc left" href="' . $link . '" title=""></a>';
		}
		else {
			$orderByList .=	'	<a class="button-arrow button-asc left" href="' . $link . '" title=""></a>';
		}
