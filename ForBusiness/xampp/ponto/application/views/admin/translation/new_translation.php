							...
							<div class="col-md-6">
							  <div class="panel panel-default">
								<div class="panel-body">
										...
										<div class="col-sm-9">
											<input id="key" type="text" class="form-control" value="<?php echo $translation->keyvalue;  ?>" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input id="value" type="text" class="form-control" value="<?php echo $translation->textvalue; ?>" >
										</div>
									</div>
								</div>
							  </div>
									...
									<div class="panel-body">
										...
										<select id="language" class="form-control">
											...
											<?php }else{
												...
												foreach ($comboboxlanguages->result() as $row) {
													if($row->language == trim($translation->lang) ){
														?>
...
function update_menuitem(){
	var id =<?php if (isset($translation->keyvalue)) {echo $translation->keyvalue;}else{ echo 0;}?>;
	var key =  $('#key').val();
	var value =  $('#value').val();
	var language =  $('#language').val();
