<?php 
/**
 * @version $Id: mod_djmegamenu.php 38 2015-06-02 11:16:12Z szymon $
 * @package DJ-MegaMenu
...
if($params->get('moo',1)) {
	...
	$doc->addScript(JURI::root(true).'/modules/mod_djmegamenu/assets/js/'.($jquery ? 'jquery.':'').'djmegamenu.js', 'text/javascript', true);
...
if($mobilemenu) {
	...
	$doc->addScript(JURI::root(true).'/modules/mod_djmegamenu/assets/js/'.($jquery ? 'jquery.':'').'djmobilemenu.js', 'text/javascript', true);
	...
	if($params->get('mobiletheme')!='_override') {
		...
		$css = 'templates/'.$app->getTemplate().'/djmobilemenu.css';
	}
