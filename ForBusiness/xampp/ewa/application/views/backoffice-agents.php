...
<div class="clearfix page-head col-md-12">
	<div class="col-md-12 col-sm-12">
		...
		<a href="<?php echo base_url(); ?>backoffice/locations" id="manage_locations" style="margin-left:15px;" class="btn btn-info pull-right"><?php echo $this->translation->Translation_key("Manage Locations", $_SESSION['lang_u']); ?></a>
		<button type="button" id="create_prod" class="btn btn-info pull-right"><?php echo $this->translation->Translation_key("Create agent", $_SESSION['lang_u']); ?></button>
		<?php }?>
	</div>
</div>
		...
		<table id="tab-products" class="table table-striped table-bordered" cellspacing="0" width="100%">
			<thead>
				<tr>
					...
					<th><?php echo $this->translation->Translation_key("VAT", $_SESSION['lang_u']); ?></th>
					...
					<th><?php echo $this->translation->Translation_key("Location", $_SESSION['lang_u']); ?></th>
					<th><?php echo $this->translation->Translation_key("Phone", $_SESSION['lang_u']); ?></th>
					<th><?php echo $this->translation->Translation_key("Email", $_SESSION['lang_u']); ?></th>
