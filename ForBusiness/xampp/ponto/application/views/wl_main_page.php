...
<div class="container">
	<div class="row centered">
		...
		<div class="home-widget-section-title"><h2 class="home-widget-title">Available Tours</h2><h2 class="home-widget-description">See our available tours</h2></div>
				...
				<div class="content-box">
					...
					<header style="background-image: url(<?php echo base_url() . 'image_product/' . $product["img"]; ?>)" class="job_listing-entry-header listing-cover has-image">
						...
						<div class="job_listing-entry-meta">
							...
							<div class="job_listing-location job_listing-location-formatted" itemprop="address" itemscope="">
								...
								<p class="col-lg-12 nomarginpadding" style="height:20px;"><?php if( $product["u_estimdur"] > 0 ) { ?> Duration: <?php echo $product["u_estimdur"] . ' ' . $product["u_estidurt"]; } ?></p>
							</div>
						</div>
						</div>
					</header>
					...
					<footer class="job_listing-entry-footer" style="text-align:center;">
						<a class="btn btn-primary" href="<?php echo base_url() . 'product/' . $product["u_sefurl"]; ?>">
									<div class="tourBtn">BOOK NOW</div>
								</a>
					</footer>
				  <!-- .entry-footer -->
			   </div>
	...
	<div class="row centered" >
		<div class="home-widget-section-title"><h2 class="home-widget-title">What to do</h2><h2 class="home-widget-description"></h2></div>
		<?php
		...
		?>
			<div id="image-grid-term-downtown-core" class="col-xs-12 col-sm-4 col-md-4 image-grid-item">
				<div style="background-image:url(<?php echo base_url() . 'image_product/' . $cat["img"]; ?>);" class="col-xs-12 col-sm-12 col-md-12 entry-cover image-grid-cover has-image">
					...
					<a href="<?php echo base_url(); ?>wl/<?php echo $op.'/listing?c=' . $cat["category"]; ?>" class="cover-wrapper"><?php echo $cat['category']; ?></a>
				</div>
			</div>
		...
		<div class="home-widget-section-title"><h2 class="home-widget-title">Cities that you can visit</h2><h2 class="home-widget-description">The Best Tours to be in</h2></div>
		<?php
		$a=array(6,7,8,12);
		$num=0;
