...
<!DOCTYPE html>
		...
		<div class="col-lg-9">
			...
			<form class="form-horizontal">
				<fieldset>
					<!-- Form Name -->
					<legend><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Personal Information'); ?></legend>
					<!-- Text input-->
					<div class="form-group">
						<label class="col-xs-12 col-md-4 control-label" for="First Name"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'First Name'); ?></label>  
					...
					<!-- Text input-->
					<div class="form-group">
						<label class="col-xs-12 col-md-4 control-label" for="Last Name"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Last Name'); ?></label>  
					...
					<!-- Text input-->
					<div class="form-group">
						<label class="col-xs-12 col-md-4 control-label" for="Tax identification number"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Tax identification number'); ?></label>  
						<div class="col-xs-12 col-md-6">
							<div class="input-group col-xs-12 col-md-12">
					...
					<!-- Text input-->
					<div class="form-group">
						<label class="col-xs-12 col-md-4 control-label" for="Date Of Birth"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Date Of Birth'); ?></label>  
						<div class="col-xs-12 col-md-6">
							<div class="input-group col-xs-12 col-md-12">
					...
					<div class="form-group">
						<label class="col-xs-12 col-md-4 control-label" for="Street"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Invoice Address'); ?></label>  
						<div class="col-xs-12 col-md-6">
					...
					<div class="form-group">
						<label class="col-xs-12 col-md-4 control-label col-xs-12" for=""></label>  
					...
					<div class="form-group">
						<label class="col-md-4 col-xs-12 control-label" for="Postcode"></label>  
					...
					<div class="form-group">
						<label class="col-md-4 col-xs-12 control-label" for="Country"></label>  
						<div class="col-md-6 col-xs-12">
					...
					<!-- Text input-->
					<div class="form-group">
						<label class="col-md-4 col-xs-12 control-label" for="Email Address"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Phone No'); ?></label>  
						<div class="col-md-6 col-xs-12">
					...
					<!-- Text input-->
					<div class="form-group">
						<label class="col-md-4 col-xs-12 control-label" for="Email Address"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Email Address'); ?></label>  
						<div class="col-md-6 col-xs-12">
							<div class="input-group col-md-12 col-xs-12">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<a href="#" onclick="window.location.href = '<?php echo base_url()?>wl/<?php echo $op; ?>/checkout';" class="btn btn-primary" value=""><span class="glyphicon glyphicon glyphicon-menu-left"></span><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Back to checkout'); ?> </a>
							<?php } ?>
						</div>
					</div>
					<div class="form-group">
...
<script>
	jQuery(document).ready(function(){
		jQuery(document).on('click','.btn-success',function() {
			var url = "<?php echo base_url(); ?>wl/<?php echo $op; ?>/account_updateaccount";
