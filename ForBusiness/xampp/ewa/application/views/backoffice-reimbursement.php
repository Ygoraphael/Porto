...
<div class="page-head col-md-12">
    <div class="col-md-12 col-sm-12">
        ...
        <button type="button" id="process" class="btn btn-info pull-right"><?php echo $this->translation->Translation_key("SET PROCESSED", $_SESSION['lang_u']); ?></button>
    </div>
</div>
        ...
        <div class="col-xs-12">
            <form action="#" class="form-horizontal group-border-dashed clearfix" >
                ...
                <div class="form-group">
                    ...
                    <label class="col-lg-2 col-sm-3 control-label"><?php echo $this->translation->Translation_key("Unprocessed only", $_SESSION['lang_u']); ?></label>
                    <div class="input-group col-lg-3 col-sm-3" style="margin-right:10px">
                        <select class="form-control" id="status" name="">
                            <option value=""></option>
                            <option value="1"><?php echo $this->translation->Translation_key("YES", $_SESSION['lang_u']); ?></option>
                            <option value="0" selected><?php echo $this->translation->Translation_key("NO", $_SESSION['lang_u']); ?></option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
            ...
            <table id="tab-pr" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th data-name="<?php
                        $_SESSION['fields'] = null;
                        $i = 0;
                        $_SESSION['fields'][$i] = $this->translation->Translation_key("Agent No", $_SESSION['lang_u']);
                        ?>"id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Agent No", $_SESSION['lang_u']); ?></th>
                        ...
                        <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Type", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Type", $_SESSION['lang_u']); ?></th>
                        <th data-name="<?php $_SESSION['fields'][$i] = $this->translation->Translation_key("Total", $_SESSION['lang_u']); ?>" id="<?php echo $i++; ?>"><?php echo $this->translation->Translation_key("Total", $_SESSION['lang_u']); ?></th>
                        <th class="text-center"><?php echo $this->translation->Translation_key("Status", $_SESSION['lang_u']); ?></th>
