...
class Listing extends CI_Controller {
	...
	public function index()
	{
		...
		$products = $this->product_model->get_products_listing($this->product_model->get_filters($this->input->get(NULL, TRUE),1),"","","",1,$agent);
		...
		$data["filters"] = $this->product_model->get_filters($this->input->get(NULL, TRUE),1);
