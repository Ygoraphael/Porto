   ...
   //<![CDATA[
   	jQuery(document).ready(function($) {
   		...
   		$('#STsameAsBTjs').click(function(event) {
   			...
   			//hack
   			jQuery.ajax({type:'POST', url:document.location.href, success: function(){location.reload();}, data:{'STsameAsBT':$('#STsameAsBT').val()}, async:false});
   			//hack
...
<div class="container">
    <div class="row">
        ...
        <div class="cart-view" id="cart-view">
            <div>
                <div class="width50 floatleft" style="margin-top:15px;">
...
if (VmConfig::get('oncheckout_show_steps', 1) && $this->checkout_task === 'confirm') {
    ...
    echo '<div class="checkoutStep" id="checkoutStep4">teste' . JText::_('COM_VIRTUEMART_USER_FORM_CART_STEP4') . '</div>';
}
?>
                <div class="width50 floatleft right" style="margin-top:15px;">
                    <?php
...
<?php // Leave A Comment Field  ?>
                <div class="customer-comment marginbottom15" style="margin-bottom:20px;">
                    <span class="comment"><?php echo JText::_('COM_VIRTUEMART_COMMENT_CART'); ?></span><br/>
                    <textarea class="customer-comment" name="customer_comment" cols="100" rows="10"><?php echo $this->cart->customer_comment; ?></textarea>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            if ($userFieldsModel->getIfRequired('agreed')) {
                                ...
                                echo VmHtml::checkbox('tosAccepted', $this->cart->tosAccepted, 1, 0, 'class="col-md-1" style="margin-top:17px;"');

                                if (VmConfig::get('oncheckout_show_legal_info', 1)) {
                                    ?>
                                    <div class="terms-of-service" style="float:left; margin-top:10px;">
                                        <label for="tosAccepted">
                                            <a href="<?php JRoute::_('index.php?option=com_virtuemart&view=vendor&layout=tos&virtuemart_vendor_id=1', FALSE) ?>" class="terms-of-service" id="terms-of-service" rel="facebox" target="_blank">
        ...
        <?php echo JText::_('COM_VIRTUEMART_CART_TOS_READ_AND_ACCEPTED'); ?>
                                        ...
                                        <div id="full-tos">
                                            <div class="main-terms">
                                                <h2 align="center"><?php echo JText::_('COM_VIRTUEMART_CART_TOS'); ?></h2>
