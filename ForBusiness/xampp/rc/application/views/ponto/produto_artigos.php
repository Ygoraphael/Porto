...
<html>
    <?php
	foreach ($trabalhador as $dados):
	$_SESSION['cod_trabalhador_temp'] = $dados['u_codcart'];
	endforeach;
        ...
        <div id="myModal" class="main-content">
            <div id="page-wrapper">
                <div class="col-lg-9">
                    <?php
                        ...
                        <div class="col-lg-2 boxhover" style="margin-bottom:25px;">
                            <a href="<?php echo base_url(); ?>ponto/artigos_qtt/<?php echo $produto["tarefastamp"]; ?>/<?php echo $produto["ststamp"]; ?>/<?php echo $produto["qtt"]; ?>" class="fancybox fancybox.iframe">
                    ...
                    <?php  $count_prod++; endforeach;
						$_SESSION['count_temp'] = $count_prod; ?>
                </div>
                <div class="col-lg-3">
                    <?php
                    if (empty($temp)) {
                        $this->load->view('ponto/fechartarefa_cart_artigos');
                    } else {
                        $this->load->view('ponto/fechartarefa_cart_artigos', $temp);
                    }
                    ?>
                </div>
                ...
                <div class="col-lg-1 " style="margin-top:4% ">
                    <button href="<?php echo base_url(); ?>ponto/cat_artigos" class="stats-ponto fancybox fancybox.iframe" data-toggle="modal" data-target="#popup"><i class="fa fa-check-square-o" style="font-size:56px;color:white"></i></button>
                    <div class="clearfix"></div>	
                </div>
                <div class="clearfix"></div>
            </div>
