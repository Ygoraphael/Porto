...
<html>
    ...
    <body>
		...
		$nome = $resp[0]["nome"];
        $dater = array();
        $dater = $porciones = explode(" ", $resp[0]["ousrdata"]);
        $date = $dater[0] . " " . $resp[0]["ousrhora"];
        ?>
                ...
                <div class="col-lg-offset-1 col-lg-10 main-page">
                    ...
                    <div class="col-lg-12 " style="margin-top:5%; ">
                        <div class="stats-ponto2 ">
                            <h4><?php echo $la = lang('There_is_already_an_entry'); ?></h4>
                            <h1><?php echo $nome; ?></h1>
                            <h4><?php echo $la = lang('hour_in') . " " . $date; ?></h4>
                        </div>
