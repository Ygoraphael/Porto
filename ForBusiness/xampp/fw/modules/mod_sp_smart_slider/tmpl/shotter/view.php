...
<div id="sp-smart-slider" class="sp-smart-slider sp-iStoreii-layout loading <?php echo $params->get('moduleclass_sfx') ?> ">
    ...
    <div class="slider-arrow-nav">
        <a class="controller-prev" href="javascript:;"><span><i class="fa fa-chevron-left" aria-hidden="true"></i></span></a>
        <a class="controller-next" href="javascript:;"><span><i class="fa fa-chevron-right" aria-hidden="true"></i></span></a>
    </div>
