	...
	<div class="row">
		<div class="col-lg-9">
			<form class="form-horizontal">
				<fieldset>
					<!-- Form Name -->
					<legend style="color:white;"><?php echo $this->googletranslate->translate($_SESSION["language_code"], 'Price'); ?>Orders</legend>
				</fieldset>
				<table class="table table-bordered account-orders-table">
					...
					<tbody>
						<tr>
							...
							<td class="text-center nomarginpadding"><button type="button" onclick="window.location.href='<?php echo base_url(); ?>account/order/<?php echo $order["bo3stamp"]; ?>'"class="btn order-details"><span class="glyphicon glyphicon-search"></span> DETAILS</button></td>
						</tr>
					<?php } ?>
					</tbody>
				</table>
