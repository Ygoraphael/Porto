  ...
  extends CBRegisto
{
  ...
  void initialize() {
    tag = "TxtEvolucao";
    started = true;
    Campos.add(new CHCampo_TextArea("texto", P.getjTextArea_Txt_1(), this));
  }
  ...
  void on_update(String tag) {
    ...
    if ((chc instanceof CHCampo_TextArea)) {
      ...
      P.jLabel_Count_1.setText(limite - n + "/" + limite);
    }
  }
  
  CHValid_Grp validar(CHValid_Grp err_list, String cp) {
    String tit = P.jLabel_Design_1.getText();
