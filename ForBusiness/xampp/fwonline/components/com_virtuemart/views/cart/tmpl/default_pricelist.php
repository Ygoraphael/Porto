 ...
 * @copyright Copyright (c) 2004 - 2010 S�ren, 2010 - 2014 VirtueMart Team. All rights reserved.
...
<table
	...
	width="100%">
<tr>
	<th style="padding-left:12px;" align="left"   width="100px"><?php echo JText::_ ('COM_VIRTUEMART_CART_SKU') ?></th>
	<th style="padding-left:12px;" align="left"   width="250px"><?php echo JText::_ ('COM_VIRTUEMART_CART_NAME') ?></th>
	<th style="padding-left:12px;" align="left"   width="250px"><?php echo JText::_ ('COM_VIRTUEMART_CART_COLECTION') ?></th>
	<th style="padding-left:12px;" align="center" width="70px"><?php echo JText::_ ('COM_VIRTUEMART_CART_PRICE_BASE') ?></th>
	<th style="padding-left:12px;" align="center" width="90px"><?php echo JText::_ ('COM_VIRTUEMART_CART_PRICE_DESC') ?></th>
	<th style="padding-left:12px;" align="right"  width="100px"><?php echo JText::_ ('COM_VIRTUEMART_CART_QUANTITY') ?></th>
	<th style="padding-left:12px;" align="right"  width="70px"><?php echo JText::_ ('COM_VIRTUEMART_CART_TOTAL') ?></th>
</tr>
...
<tr valign="top" class="sectiontableentry<?php echo $i ?>">
	<td align="left">
		<?php
			$pieces = explode("|||", $prow->product_sku);
			echo $pieces[0];
		?>
	</td>
	<td align="left">
		<?php
			...
			echo "<br>" . JText::_ ('MOD_VIRTUEMART_SIZE') . ": " . $pieces[2] . "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>" . JText::_ ('MOD_VIRTUEMART_COLOR') . ": " . $pieces[3];
		?>
	</td>
	<td align="left">
		<?php
			echo $prow->category_name;
		?>
	</td>
	<td align="center">
		<?php
		...
		$sql .= "	where virtuemart_product_id = " . $db->quote($prow->virtuemart_product_id);
		$sql .= "	limit 1 ";
		...
		if( $num_rows > 0 ) {
			$desconto = $field_prod[0][0];
		}
		else {
			$desconto = 0;
		}

		echo str_replace('.', ',', number_format( ($this->cart->pricesUnformatted[$pkey]['basePriceVariant'] / (1-($desconto/100)))*(1 + ($taxa_iva/100)) , 2)) . " &euro;";
	...
	<td align="center">
		<?php
			echo str_replace('.', ',', number_format( ($this->cart->pricesUnformatted[$pkey]['basePriceVariant'])*(1 + ($taxa_iva/100)), 2)) . " &euro;";
		?>
	</td>
...
//				$step=$prow->min_order_level;
				...
				<?php echo  JText::_('COM_VIRTUEMART_CART_UPDATE') ?>" class="inputbox" size="3" maxlength="4" name="quantity" value="<?php echo $prow->quantity ?>" /> -->
            <input type="text"
				   ...
				   title="<?php echo  JText::_('COM_VIRTUEMART_CART_UPDATE') ?>"
					 ...
					 style="vertical-align:top;margin-top:2px; width:100%;"
					 size="3" maxlength="4" name="quantity[<?php echo $prow->cart_item_id ?>]" value="<?php echo $prow->quantity ?>" />
		<br>
		<center>
		<input type="submit" style="width:22%;"  class="btnUnstyled vmicon vm2-add_quantity_cart" name="update[<?php echo $prow->cart_item_id ?>]" title="<?php echo  JText::_ ('COM_VIRTUEMART_CART_UPDATE') ?>" align="middle" value=""/>
		<a class="vmicon vm2-remove_from_cart" style="margin-top:4px;" title="<?php echo JText::_ ('COM_VIRTUEMART_CART_DELETE') ?>" align="middle" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart&task=delete&cart_virtuemart_product_id=' . $prow->cart_item_id) ?>" rel="nofollow"> </a>
	</center>
	</td>
...
<tr class="sectiontableentry1" style="background-color: rgba(0, 0, 0, 0.1);">
...
<tr>
	<td colspan="2">&nbsp;</td>
	<td colspan="5" ><h3 style="text-align:right; font-size:12px;"><?php echo JText::_( 'IVAPreco' ); ?></h3></td>
</tr>
...
<tr class="sectiontableentry1" style="border-bottom:1px rgba(0, 0, 0, 0.1) solid;" valign="top" >
...
<tr class="sectiontableentry2" style="background-color: rgba(0, 0, 0, 0.1);">
	<td colspan="6" align="right"><?php echo JText::_ ('COM_VIRTUEMART_CART_TOTAL') ?>:</td>
...
<tr class="sectiontableentry2 totalInPaymentCurrency">
	<td colspan="5" align="right"><?php echo JText::_ ('COM_VIRTUEMART_CART_TOTAL_PAYMENT') ?>:</td>
	...
	<table>
		...
		<tr>
			<td style="width:50%; text-align: right;">
				<a class="" id="output-billto-edit" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=BT', $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
			...
			<td style="width:50%; text-align: right;">
				...
				<a class="" id="output-shipto-add" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&virtuemart_user_id[]=' . $this->cart->lists['current_id'], $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
