...
public class Bi {
    ...
    public boolean save( Statement stmt ) {
        ...
        this.lastSQL = "INSERT INTO bi(bistamp, bostamp, ref, design, qtt, iva, "
                ...
                + "ousrhora, usrinis, usrdata, usrhora, desconto, ivaincl, tam, cor, unidade, lordem, u_codproj, u_descproj, cativo) "
                ...
                + "'" + this.tam + "', '" + this.cor +  "', 'UNI', "+this.lordem+", "+this.u_codproj+", isnull((select top 1 trab3 from bo where obrano = "+this.u_codproj+" and ndos = 7), ''), "+this.cativo+")";
