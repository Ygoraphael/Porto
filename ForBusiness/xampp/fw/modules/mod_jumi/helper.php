...
class modJumiHelper {
    static function getCodeWritten(&$params) { //returns code written or ""
        return trim($params->get( 'code_written' ));
    }

    static function getStorageSource(&$params) { //returns filepathname or a record id or ""
    ...
    static function getCodeStored($source) { //returns code stored in the database or null.
