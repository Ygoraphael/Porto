...
<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/pure-release-0.6.0/pure-min.css" type="text/css" />
<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/prod_cat.css" type="text/css" />
</head>
...
<div class="techton">by <a href="http://ajoomlatemplates.com" target="_blank" title="joomla 3.0 templates">AJoomlaTemplates</a> and <a href="http://www.reviewbuilder.com/inmotion-hosting/" target="_blank" title="InMotion">InMotion Hosting Review</a></div><?php } ?>
<div class="clr"></div>
</div></div>
</body>
</html>