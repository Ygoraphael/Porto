...
<body>
<form class="jotform-form" action="insert_formando_individual.php" method="post" name="form_11301836230" id="11301836230" accept-charset="utf-8">
    ...
    <ul class="form-section page-section">
        ...
        <div class="form-header-group ">
          <div class="header-text httal htvam">
            <h2 id="header_10" class="form-header" data-component="header">
              Inscrição Formandos (individual)
            </h2>
        ...
        <div id="cid_7" class="form-input jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top;">
              <input type="text" id="last_7" name="NomeFormando5" class="form-textbox" size="15" value="" data-component="last" />
      ...
      <li class="form-line" data-type="control_email" id="id_8">
        ...
        <div id="cid_8" class="form-input jf-required">
          <input type="email" id="input_8" name="Email5" class="form-textbox validate[Email]" size="20" value="" placeholder="ex: myname@example.com" data-component="email" />
        </div>
      </li>
      <li class="form-line" data-type="control_phone" id="id_9">
        ...
        <div id="cid_9" class="form-input jf-required">
          <div data-wrapper-react="true">
            ...
            <span class="form-sub-label-container" style="vertical-align:top;">
              <input type="tel" id="input_9_phone" name="Telemovel5" class="form-textbox" size="8" value="" data-component="phone" />
      ...
      <li class="form-line" data-type="control_textbox" id="id_4">
        ...
        <div id="cid_4" class="form-input jf-required">
          <input type="date" id="input_4" name="DataNasc5" data-type="input-textbox" class="form-textbox" size="10" value="" placeholder=" " data-component="textbox" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_4">
        <label class="form-label form-label-left form-label-auto" id="label_4" for="input_4"> Morada: </label>
        <div id="cid_4" class="form-input jf-required">
          <input type="text" id="input_4" name="Morada5" data-type="input-textbox" class="form-textbox" size="10" value="" placeholder=" " data-component="textbox" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_4">
        <label class="form-label form-label-left form-label-auto" id="label_4" for="input_4"> Código Postal: </label>
        <div id="cid_4" class="form-input jf-required">
          <input type="text" id="input_4" name="CodigoPostal5" data-type="input-textbox" class="form-textbox" size="10" value="" placeholder=" " data-component="textbox" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_4">
        <label class="form-label form-label-left form-label-auto" id="label_4" for="input_4"> Cartão de Cidadão: </label>
        <div id="cid_4" class="form-input jf-required">
          <input type="text" id="input_4" name="CartaoCidadao5" data-type="input-textbox" class="form-textbox" size="10" value="" placeholder=" " data-component="textbox" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_4">
        <label class="form-label form-label-left form-label-auto" id="label_4" for="input_4"> Validade Cartão de Cidadão: </label>
        <div id="cid_4" class="form-input jf-required">
          <input type="date" id="input_4" name="Validade5" data-type="input-textbox" class="form-textbox" size="10" value="" placeholder=" " data-component="textbox" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_4">
        <label class="form-label form-label-left form-label-auto" id="label_4" for="input_4"> Carta Condução: </label>
        <div id="cid_4" class="form-input jf-required">
          <input type="text" id="input_4" name="nCartaConducao5" data-type="input-textbox" class="form-textbox" size="10" value="" placeholder=" " data-component="textbox" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_4">
        <label class="form-label form-label-left form-label-auto" id="label_4" for="input_4"> Data Emissão Cartão de Cidadão: </label>
        <div id="cid_4" class="form-input jf-required">
          <input type="date" id="input_4" name="DataEmissao5" data-type="input-textbox" class="form-textbox" size="10" value="" placeholder=" " data-component="textbox" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_4">
        <label class="form-label form-label-left form-label-auto" id="label_4" for="input_4"> NIF: </label>
        <div id="cid_4" class="form-input jf-required">
          <input type="text" id="input_4" name="NIF5" data-type="input-textbox" class="form-textbox" size="10" value="" placeholder=" " data-component="textbox" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_4">
        <label class="form-label form-label-left form-label-auto" id="label_4" for="input_4"> Data Renovação ADR: </label>
        <div id="cid_4" class="form-input jf-required">
          <input type="date" id="input_4" name="DataRenovADR5" data-type="input-textbox" class="form-textbox" size="10" value="" placeholder=" " data-component="textbox" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_4">
        <label class="form-label form-label-left form-label-auto" id="label_4" for="input_4"> Data Renovação CAM: </label>
        <div id="cid_4" class="form-input jf-required">
          <input type="date" id="input_4" name="DataRenovCAM5" data-type="input-textbox" class="form-textbox" size="10" value="" placeholder=" " data-component="textbox" />
        </div>
      </li>
...
<!-- 
      ...
      <li class="form-line" data-type="control_fullname" id="id_12">
        ...
        <div id="cid_12" class="form-input jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top;">
              <input type="text" id="last_12" name="NomeFormando2" class="form-textbox" size="15" value="" data-component="last" />
        ...
        <div id="cid_12" class="form-input jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top;">
              <input type="text" id="last_12" name="Morada2" class="form-textbox" size="15" value="" data-component="last" />
              <label class="form-sub-label" for="last_12" id="sublabel_last" style="min-height:13px;"> x </label>
            </span>
          </div>
        </div>
