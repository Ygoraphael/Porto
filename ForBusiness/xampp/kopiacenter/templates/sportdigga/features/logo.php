...
class GantryFeaturelogo extends GantryFeature {
    ...
    function render($position) {
        ...
        <div class="rt-block logo-block">
            <a href="<?php echo $gantry->baseUrl; ?>" id="rt-logo"><img id="rt-logo-img" alt="" src="<?php echo $gantry->baseUrl; ?>templates/<?php echo $gantry->getCurrentTemplate(); ?>/images/logo/logo-small.png" alt=""/></a>
        </div>
        <?php
        return ob_get_clean();
    }
