...
if ($user2 == 1) {
    $tpl = new Template(APP_PATH_TPL . 'panel/insecuritys/Form_pc_insecuritysAdmin.html');
    ...
    $tpl = new Template(APP_PATH_TPL . 'panel/insecuritys/Form_pc_insecuritysCompany.html');
