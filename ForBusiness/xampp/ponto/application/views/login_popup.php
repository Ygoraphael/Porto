		...
		<article class="container-login center-block">
			<section>
				<ul id="top-bar" class="nav nav-tabs nav-justified">
					<li id="login-form-link" class="active"><a href="#login-access">Login</a></li>
					<li id="register-form-link"><a href="#">Register</a></li>
				</ul>
					...
					<div id="login-access" class="tab-pane fade active in">					
						<form id="form1" method="post" accept-charset="utf-8" autocomplete="off" role="form" class="form-horizontal">
							...
							<div class="form-group" id="btn-login-fb">	
								<button type="button" class="btn btn-lg btn-primary">LOGIN WITH FACEBOOK</button>
							</div>
							<div class="form-group centered">	
								<a href="#" style="color:#818080;font-size: 13px;font-weight: 100;text-transform: uppercase;">Reset Password</a>
							</div>
						</form>			
					</div>
				</div>
					...
					<div id="register-access" class="tab-pane fade active in">					
						<form id="form2" method="post" accept-charset="utf-8" autocomplete="off" role="form" class="form-horizontal">
							<div class="form-group ">
								...
								<input type="text" class="form-control" name="reg-email" id="reg-email" placeholder="Email" tabindex="1" value="" />
							</div>
							<div class="form-group ">
								<label for="password" class="sr-only">Password</label>
									<input type="password" class="form-control" name="reg-password" id="reg-password" placeholder="Password" value="" tabindex="2" />
							</div>
							<div class="form-group ">
								<label for="password" class="sr-only">Confirm Password</label>
									<input type="password" class="form-control" name="reg-cpassword" id="reg-cpassword" placeholder="Confirm Password" value="" tabindex="3" />
							</div>
							<div class="form-group ">				
								<button name="register-me-in" id="btn-register" tabindex="5" class="btn btn-lg btn-primary">REGISTER NOW</button>
							</div>
							<div class="divider">
								<div class="sep"></div>
								<div class="middle">or</div>
							...
							<div class="form-group" id="btn-register-fb">	
								<button class="btn btn-lg btn-primary">REGISTER WITH FACEBOOK</button>
							</div>
						</form>			
					</div>
				</div>
