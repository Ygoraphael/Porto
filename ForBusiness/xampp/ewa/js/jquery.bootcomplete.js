...
(function ( $ ) {
    ...
    $.fn.bootcomplete = function(options) {
        ...
        function searchQuery(obj){
            ...
            var Data = $.extend({query: obj.val()}, settings.dataParams, dyFormParams);
            
            if(!Data.query){
                obj.next('.'+settings.menuClass).html('')    
                obj.next('.'+settings.menuClass).hide()    
            }
                ...
                xhr = $.ajax({
                    ...
                    success: function( json ) {
                        ...
                        $.each( json, function(i, j) {
                            results += '<a href="listing?s='+j.label+'" class="list-group-item" data-id="'+j.id+'" data-label="'+j.label+'">'+j.label+'</a>'
                        });
