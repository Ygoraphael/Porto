...
class VirtueMartControllerCart extends JController {
	...
	public function update() {
		...
		if ($cartModel->updateProductCart() == -1 ) $mainframe->enqueueMessage(JText::_('COM_VIRTUEMART_CART_PRODUCT_OUT_OF_QUANTITY'), 'error');
		else if ($cartModel->updateProductCart() ) $mainframe->enqueueMessage(JText::_('COM_VIRTUEMART_PRODUCT_UPDATED_SUCCESSFULLY'));
